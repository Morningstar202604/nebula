...
Generates UPCOMING_CHANGELOG.md by running the nebula changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for nebula run (default: low)
      --quiet            Suppress nebula command output unless it fails
