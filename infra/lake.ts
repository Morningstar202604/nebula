...
const tableBucketName = `nebula-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `nebula-${$app.stage}-lake-ingest`,
    destination: "iceberg",
