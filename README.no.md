...
brew install anomalyco/tap/nebula # macOS og Linux (anbefalt, alltid oppdatert)
...
Nebula er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/anomalyco/nebula/releases) eller [nebula.ai/download](https://nebula.ai/download).
