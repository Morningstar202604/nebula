...
import { compile, emitEffectImported, emitPromise, write } from "@nebula-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "NebulaEventEncoded",
              import: 'import type { NebulaEventEncoded } from "@nebula-ai/protocol/groups/event"',
            },
          },
        }),
