...
import { and, Database, eq, isNull } from "@nebula-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@nebula-ai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "Nebula Go subscription required.",
        },
      }),
      {
        status: 403,
