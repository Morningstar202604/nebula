...
import compareVideo from "../../asset/lander/nebula-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/nebula-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="nebula:auth" content={loggedin() ? "true" : "false"} />
