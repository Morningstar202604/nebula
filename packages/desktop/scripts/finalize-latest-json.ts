...
const releaseId = process.env.NEBULA_RELEASE
if (!releaseId) throw new Error("NEBULA_RELEASE is required")

const version = process.env.NEBULA_VERSION
if (!version) throw new Error("NEBULA_VERSION is required")
...
const macxTarGz = "nebula-desktop-mac-x64.app.tar.gz"
const macaTarGz = "nebula-desktop-mac-arm64.app.tar.gz"
