export const dict = {
  ...
  "desktop.updater.none.message": "Nebula'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Nebula'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'nebula' komutunu kullanmak için terminalinizi yeniden başlatın.",
