export const dict = {
  ...
  "desktop.updater.none.message": "Artıq Nebula-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Nebula-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'nebula' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
