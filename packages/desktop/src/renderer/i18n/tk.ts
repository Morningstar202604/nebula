export const dict = {
  ...
  "desktop.updater.none.message": "Nebula-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Nebula-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'nebula' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
