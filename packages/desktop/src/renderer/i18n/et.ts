export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Nebula uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Nebula'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „nebula” kasutamiseks taaskäivitage terminal.",
