export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Nebula",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Nebula is gedownload. Wil je deze installeren en Nebula opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'nebula' te gebruiken.",
