export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Nebula ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Nebulaning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'nebula' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
