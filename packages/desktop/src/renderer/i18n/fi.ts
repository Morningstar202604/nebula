export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Nebulan uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Nebulan versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Nebulan uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'nebula'-komentoa.",
