...
import { EventManifest } from "@nebula-ai/schema/event-manifest"
import { Location } from "@nebula-ai/schema/location"
import type { Definition } from "@nebula-ai/schema/event"
...
export const NebulaEvent = event.schema
export type NebulaEvent = typeof NebulaEvent.Type
export type NebulaEventEncoded = typeof NebulaEvent.Encoded
