---
title: Zen
description: Kuratierte Modellliste direkt von Nebula.
---
...
Nebula Zen ist eine Liste von getesteten und verifizierten Modellen, die vom Nebula-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in Nebula. Du meldest dich bei Nebula Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Nebula zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Nebula funktionieren.
:::
...
Nebula Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Nebula Zen funktioniert wie jeder andere Provider in Nebula.

1. Du meldest dich bei **<a href={console}>Nebula Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Nebula Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Nebula-Konfiguration verwendet das Format `nebula/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `nebula/gpt-5.5` in deiner Konfiguration verwenden.
...
Möglicherweise siehst du [kostengünstige Modelle](/docs/config/#models) wie Haiku, Nano oder Flash in deinem Nutzungsverlauf. Nebula verwendet diese Modelle, um Session-Titel zu generieren.
...
- MiMo-V2.5 Free ist für begrenzte Zeit auf Nebula verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Hy3 Free ist für begrenzte Zeit auf Nebula verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf Nebula verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3.5 Lightning Free ist für begrenzte Zeit auf Nebula verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Nebula verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Muse Spark 1.2 Contributor Free ist für begrenzte Zeit auf Nebula verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Nebula Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Nebula auch jeden anderen Provider zu verwenden.
