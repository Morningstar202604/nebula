...
Erstellen Sie `.nebula/commands/test.md`:

```md title=".nebula/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Nebula-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Nebula [config](/docs/config):

```json title="nebula.jsonc" {4-12}
{
...
- Global: `~/.config/nebula/commands/`
- Pro Projekt: `.nebula/commands/`

```markdown title="~/.config/nebula/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".nebula/commands/component.md"
---
...
```md title=".nebula/commands/create-file.md"
---
...
```md title=".nebula/commands/analyze-coverage.md"
---
...
```md title=".nebula/commands/review-changes.md"
---
...
```md title=".nebula/commands/review-component.md"
---
...
Nebula enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
