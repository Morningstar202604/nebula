---
title: Teilen
description: Teile Nebula-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Nebula-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Nebula Folgendes:
...
Nebula hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Nebula den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`nebula.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du nebula in deiner Organisation einsetzt.
