...
Agentferdigheter lar Nebula oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går nebula opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
nebula viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `nebula.json`:
