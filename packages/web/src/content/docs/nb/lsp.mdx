---
title: LSP-servere
description: nebula integreres med LSP-serverne dine.
---

Nebula kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Nebula kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `NEBULA_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og nebula åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Nebula-konfigurasjonen.
