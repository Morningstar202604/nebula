...
Opprett `.nebula/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Nebula-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Nebula [config](/docs/config):
...
Nebula inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
