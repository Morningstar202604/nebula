---
title: TUI
description: Bruke nebula-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Nebula gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Nebula starter TUI for gjeldende katalog.
...
Når du bruker Nebula TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Nebula. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Nebula. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `nebula.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Nebula venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `nebula.default`.
