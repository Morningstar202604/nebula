---
title: Zen
description: Lista seleccionada de modelos proporcionada por Nebula.
---
...
Nebula Zen es una lista de modelos probados y verificados proporcionada por el equipo de Nebula.

Zen funciona como cualquier otro proveedor en Nebula. Inicias sesión en Nebula Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Nebula.
:::
...
Nebula Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Nebula Zen funciona como cualquier otro proveedor en Nebula.

1. Inicias sesión en **<a href={console}>Nebula Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Nebula Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Nebula
usa el formato `nebula/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`nebula/gpt-5.5` en tu configuración.
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. Nebula usa estos modelos para generar títulos de sesiones.
...
- MiMo-V2.5 Free está disponible en Nebula por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Hy3 Free está disponible en Nebula por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Nebula por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3.5 Lightning Free está disponible en Nebula por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Nebula por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Muse Spark 1.2 Contributor Free está disponible en Nebula por tiempo limitado. El equipo está aprovechando este período para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Nebula.
