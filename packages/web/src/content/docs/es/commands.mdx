...
Puede agregar comandos personalizados a través de la configuración Nebula o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Nebula [config](/docs/config):
...
nebula incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
