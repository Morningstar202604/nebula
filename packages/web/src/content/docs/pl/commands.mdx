...
Utwórz `.nebula/commands/test.md`:
...
Możesz zdefiniować polecenia w `nebula.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji nebula:
...
- Globalnie: `~/.config/nebula/commands/`
- Na projekt: `.nebula/commands/`
...
nebula zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
