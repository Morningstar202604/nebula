---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala nebula.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

nebula zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie nebula uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI nebula, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do nebula. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij nebula. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `nebula.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Nebula czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `nebula.default`.
