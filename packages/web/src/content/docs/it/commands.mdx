...
Puoi aggiungere comandi personalizzati tramite la config di Nebula o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Nebula:
...
- Globale: `~/.config/nebula/commands/`
- Per progetto: `.nebula/commands/`
...
nebula include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
