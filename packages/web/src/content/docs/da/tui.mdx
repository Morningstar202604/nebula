---
title: TUI
description: Brug af Nebula-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Nebula giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Nebula starter TUI for den nuværende mappe.
...
Når du bruger Nebula TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Nebula. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Nebula. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `nebula.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Nebula venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `nebula.default`.
