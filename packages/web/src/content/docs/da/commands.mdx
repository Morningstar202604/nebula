...
Du kan tilføje brugerdefinerede kommandoer gennem Nebula-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Nebula [config](/docs/config):
...
- Globalt: `~/.config/nebula/commands/`
- Pr. projekt: `.nebula/commands/`
...
nebula indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
