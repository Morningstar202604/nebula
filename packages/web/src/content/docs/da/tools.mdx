...
Her er alle de innebygde verktøyene som er tilgængelige i Nebula.
...
:::note
Dette verktøyet er bare tilgængelig når `NEBULA_EXPERIMENTAL_LSP_TOOL=true` (eller `NEBULA_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Nebula-leverandøren eller når miljøvariabelen `NEBULA_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
