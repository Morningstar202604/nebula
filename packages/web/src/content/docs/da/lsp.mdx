---
title: LSP-servere
description: Nebula integreres med dine LSP-servere.
---

Nebula kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Nebula leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `NEBULA_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og nebula åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din nebula-konfiguration.
