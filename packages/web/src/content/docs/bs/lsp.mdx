---
title: LSP serveri
description: Nebula se integriše sa vašim LSP serverima.
---

Nebula se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Nebula dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `NEBULA_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i nebula otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj nebula konfiguraciji.
