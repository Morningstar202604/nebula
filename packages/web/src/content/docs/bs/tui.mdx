---
title: TUI
description: Korištenje korisničkog interfejsa Nebula terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Nebula pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Nebula pokreće TUI za trenutni direktorij.
...
Kada koristite Nebula TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Nebula. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Nebula. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `nebula.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Nebula čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `nebula.default`.
