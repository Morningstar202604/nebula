---
title: SDK
description: Type-safe JS klijent za nebula server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

nebula JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje nebula-om.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `nebula.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu nebula instancu, mozete napraviti klijentsku instancu i povezati se na nju:
