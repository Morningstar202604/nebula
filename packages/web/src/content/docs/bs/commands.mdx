...
Kreiraj `.nebula/commands/test.md`:
...
Možete dodati prilagođene komande kroz Nebula konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Nebula [config](/docs/config):
...
- Globalno: `~/.config/nebula/commands/`
- Po projektu: `.nebula/commands/`
...
Nebula uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
