---
title: Share
description: Share your Nebula conversations.
---

Nebula's share feature allows you to create public links to your Nebula conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Nebula:
...
Nebula supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Nebula uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `nebula.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using nebula in your organization.
