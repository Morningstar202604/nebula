---
title: Özel Araçlar
description: LLM'un nebula'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. nebula'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.nebula/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/nebula/tools/` içine yerleştirerek.
