---
title: Paylasim
description: nebula konusmalarini genel baglantilarla paylasin.
---

nebula'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda nebula:
...
nebula, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak nebula manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `nebula.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda nebula kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
