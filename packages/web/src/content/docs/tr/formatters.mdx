...
description: nebula dile özgü biçimlendiriciler kullanır.
---

nebula, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

nebula, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, nebula bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

nebula bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri nebula yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
