...
`.nebula/commands/test.md` oluştur:
...
nebula işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

nebula [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/nebula/commands/`
- Proje başına: `.nebula/commands/`
...
nebula, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
