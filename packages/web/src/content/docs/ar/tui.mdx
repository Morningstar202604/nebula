---
title: TUI
description: استخدام واجهة المستخدم TUI في Nebula.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Nebula واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Nebula إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Nebula في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Nebula. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Nebula. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `nebula.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Nebula بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `nebula.default`.
