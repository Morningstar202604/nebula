...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Nebula:
...
- ระดับผู้ใช้ (Global): `~/.config/nebula/commands/`
- ระดับโปรเจ็กต์: `.nebula/commands/`
...
Nebula มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
