...
import { IconNebula } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "nebula/session/message-v2"
import type { Message } from "nebula/session/message"
import type { Session } from "nebula/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.nebula_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.nebula_name}>
                    <IconNebula width={16} height={16} />
                  </div>
