...
class Database extends Context.Service<Database, DatabaseShape>()("@nebula/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@nebula/example/UserStore") {
