...
export const TypeId: TypeId = "~@nebula-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@nebula-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@nebula-ai/effect-sqlite-node/NodeSqliteClient")
