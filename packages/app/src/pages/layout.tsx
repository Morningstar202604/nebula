...
import { base64Encode } from "@nebula-ai/core/util/encode"
...
import { Session } from "@nebula-ai/sdk/v2/client"
...
import { retry } from "@nebula-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@nebula-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://nebula.ai/desktop-feedback")}
      renderPanel={() =>
