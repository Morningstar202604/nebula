...
import { Icon } from "@nebula-ai/ui/v2/icon"
...
import { useTheme } from "@nebula-ai/ui/theme"
...
const featuredProviders = ["nebula", "nebula-go", "openai", "anthropic", "google", "github-copilot"]
...
export const DialogSelectModelUnpaidV2: Component<{ model?: ModelState }> = (props) => {
  ...
  const isFree = (item: ReturnType<ModelState["list"]>[number]) =>
    item.provider.id === "nebula" && (!item.cost || item.cost.input === 0)
