...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "nebula", key: "dialog.provider.nebula.note" },
  { match: (id: string) => id === "nebula-go", key: "dialog.provider.nebulaGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "nebula" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "nebula" || item.id === "nebula-go"}>
