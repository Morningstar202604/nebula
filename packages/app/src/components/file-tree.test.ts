...
beforeAll(async () => {
  ...
  mock.module("@nebula-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@nebula-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@nebula-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@nebula-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
