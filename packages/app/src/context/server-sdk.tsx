import type { NebulaEvent } from "@nebula-ai/client/promise"
import type { Event } from "@nebula-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: NebulaEvent }
...
export function adaptServerEvent(event: NebulaEvent): ServerEvent {
...
function currentDelta(event: NebulaEvent | undefined): CurrentDelta | undefined {
  if (
