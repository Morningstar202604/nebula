...
import { NormalizedProviderListResponse } from "@nebula-ai/session-ui/context"
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: NebulaClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  scope: ServerScope,
  serverSDK: () => NebulaClient,
  serverAPI: ServerApi,
  sdkFor: (dir: PathKey) => NebulaClient,
  protocol: Promise<"v1" | "v2">,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, NebulaClient>()
