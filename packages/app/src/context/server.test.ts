  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://nebula.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://nebula.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://nebula.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          ...
          lastProject: { local: "/local", "https://nebula.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://nebula.example.com"),
      ),
    ).toEqual({
