...
import type { Config, NebulaClient, Project } from "@nebula-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@nebula-ai/client/promise"
import type { NormalizedProviderListResponse } from "@nebula-ai/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
