import type { SessionApi } from "@nebula-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { NebulaClient } from "@nebula-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: NebulaClient; directory: string; limit: number }) {
  try {
