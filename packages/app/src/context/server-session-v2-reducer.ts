import type { NebulaEvent, SessionMessageInfo, SessionPendingMessage } from "@nebula-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: NebulaEvent): V2SessionReduction | undefined => {
