...
const GLOBAL_STORAGE = "nebula.global.dat"
const WINDOW_STORAGE = "nebula.window"
const LOCAL_PREFIX = "nebula."
...
function workspaceStorage(dir: string) {
  ...
  return `nebula.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `nebula.draft.${head}.${sum}.dat`
}
