export const dict = {
  ...
  "desktop.menu.documentation": "Nebula Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Nebula մենյու",
  ...
  "desktop.recovery.loadFailed": "Nebula չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Nebula պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Nebula-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installNebula": "Nebula տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.nebulaMissing": "nebula-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.nebulaCannotRun": "nebula-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.nebula.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.nebula.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.nebulaGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Nebula",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Nebula-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Այցելություն ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Nebula-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Nebula-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են nebula.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Nebula սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingNebula": "Ստուգում է Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Ստուգում է Nebula-ը {{distro}}...",
  "wsl.onboarding.updatingNebula": "Թարմացվում է Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Թարմացվում է Nebula-ը {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Թարմացնել Nebula-ը {{distro}}-ում։",
  "wsl.onboarding.updateNebula": "Թարմացնել Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.nebulaReady": "Nebula պատրաստ է։",
  "wsl.onboarding.installNebulaIn": "Տեղադրեք Nebula-ը {{distro}}-ում։",
  "wsl.onboarding.installNebula": "Տեղադրեք Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Nebula-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Nebula-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Nebula։",
  ...
  "help.tabs.introduction": "Nebula Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Nebula թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (nebula.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Nebula-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Nebula ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Nebula սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Nebula",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Nebula տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Nebula-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Nebula-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Nebula-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Nebula-ի վերջին տարբերակը։",
