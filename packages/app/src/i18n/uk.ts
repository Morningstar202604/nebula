export const dict = {
  ...
  "desktop.menu.documentation": "Документація Nebula",
  ...
  "desktop.menu.ariaLabel": "Меню Nebula",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Nebula",
  "desktop.recovery.terminated": "Роботу вікна Nebula несподівано завершено",
  "desktop.recovery.unresponsive": "Nebula не відповідає",
  ...
  "desktop.wsl.error.installNebula": "Не вдалося встановити Nebula",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.nebulaMissing": "nebula не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.nebulaCannotRun": "nebula встановлено, але його не вдалося запустити",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Nebula завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.nebula.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.nebula.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.nebulaGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Nebula",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Відвідайте ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Nebula.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в nebula.json",
  ...
  "dialog.server.description": "Перемкніть сервер Nebula, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingNebula": "Перевірка Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Перевірка Nebula у {{distro}}...",
  "wsl.onboarding.updatingNebula": "Оновлення Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Оновлення Nebula у {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Оновіть Nebula у {{distro}}.",
  "wsl.onboarding.updateNebula": "Оновити Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula готовий до роботи у {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula готовий до роботи.",
  "wsl.onboarding.installNebulaIn": "Встановіть Nebula у {{distro}}.",
  "wsl.onboarding.installNebula": "Встановити Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Nebula потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Nebula не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Nebula ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Nebula",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (nebula.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Nebula ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Nebula всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Nebula",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Nebula на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Nebula використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Nebula.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Nebula",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Nebula.",
