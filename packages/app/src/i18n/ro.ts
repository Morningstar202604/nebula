export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Nebula",
  ...
  "desktop.menu.ariaLabel": "Meniu Nebula",
  ...
  "desktop.recovery.loadFailed": "Nebula nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Nebula s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Nebula nu răspunde",
  ...
  "desktop.wsl.error.installNebula": "Instalarea Nebula a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.nebulaMissing": "nebula nu este instalat în această distribuție",
  "desktop.wsl.error.nebulaCannotRun": "nebula este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Nebula s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.nebula.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.nebula.tagline": "Modele optimizate, fiabile",
  "dialog.provider.nebulaGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Nebula",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.nebulaZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.nebulaZen.visit.prefix": "Vizitează",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Nebula.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în nebula.json",
  ...
  "dialog.server.description": "Schimbă serverul Nebula la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingNebula": "Se verifică Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Se verifică Nebula în {{distro}}...",
  "wsl.onboarding.updatingNebula": "Se actualizează Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Se actualizează Nebula în {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Actualizează Nebula în {{distro}}.",
  "wsl.onboarding.updateNebula": "Actualizează Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula este gata în {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula este gata.",
  "wsl.onboarding.installNebulaIn": "Instalează Nebula în {{distro}}.",
  "wsl.onboarding.installNebula": "Instalează Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Nebula să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Nebula nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Nebula ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Nebula",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (nebula.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Nebula nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Nebula în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Nebula",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Nebula pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Nebula urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Nebula.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Nebula",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Nebula.",
