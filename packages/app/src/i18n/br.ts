export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Nebula",
  ...
  "desktop.menu.ariaLabel": "Menu do Nebula",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Nebula",
  "desktop.recovery.terminated": "A janela do Nebula foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Nebula não está respondendo",
  ...
  "desktop.wsl.error.installNebula": "Falha na instalação do Nebula",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.nebulaMissing": "O nebula não está instalado nesta distribuição",
  "desktop.wsl.error.nebulaCannotRun": "O nebula está instalado, mas não pôde ser executado",
  "desktop.wsl.error.nebulaNotInstalled": "O Nebula não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Nebula foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.nebula.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.nebula.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.nebulaGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Nebula",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.nebulaZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.nebulaZen.visit.prefix": "Visite ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Nebula.",
  ...
  "dialog.plugins.empty": "Plugins configurados em nebula.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Nebula este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingNebula": "Verificando o Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Verificando o Nebula em {{distro}}...",
  "wsl.onboarding.updatingNebula": "Atualizando o Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Atualizando o Nebula em {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Atualize o Nebula em {{distro}}.",
  "wsl.onboarding.updateNebula": "Atualizar o Nebula",
  "wsl.onboarding.nebulaReadyIn": "O Nebula está pronto em {{distro}}.",
  "wsl.onboarding.nebulaReady": "O Nebula está pronto.",
  "wsl.onboarding.installNebulaIn": "Instale o Nebula em {{distro}}.",
  "wsl.onboarding.installNebula": "Instalar o Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Nebula possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Nebula não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Nebula novamente.",
  ...
  "help.tabs.introduction": "Agora, o Nebula Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Nebula ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Nebula",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (nebula.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Nebula ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Nebula dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Nebula",
  ...
  "settings.general.row.appearance.description": "Personalize como o Nebula aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Nebula segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Nebula é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Nebula iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Nebula.",
