export const dict = {
  ...
  "desktop.menu.documentation": "Nebula Skjøl",
  ...
  "desktop.menu.ariaLabel": "Nebula valmynd",
  ...
  "desktop.recovery.loadFailed": "Nebula miseydnaðist at heinta",
  "desktop.recovery.terminated": "Nebula vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Nebula svarar ikki",
  ...
  "desktop.wsl.error.installNebula": "Nebula uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.nebulaMissing": "nebula er ikki sett upp í hesi distro",
  "desktop.wsl.error.nebulaCannotRun": "nebula er sett upp men kundi ikki koyra",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.nebula.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.nebula.tagline": "Álítandi optimerað modell",
  "dialog.provider.nebulaGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Nebula",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.nebulaZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.nebulaZen.visit.prefix": "Vitja ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Nebula.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í nebula.json",
  ...
  "dialog.server.description": "Skift hvønn Nebula ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingNebula": "Kanna Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Kanna Nebula í {{distro}}...",
  "wsl.onboarding.updatingNebula": "Dagføring Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Dagføring Nebula í {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Dagfør Nebula í {{distro}}.",
  "wsl.onboarding.updateNebula": "Dagfør Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula er klárt í {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula er klárt.",
  "wsl.onboarding.installNebulaIn": "Set Nebula upp í {{distro}}.",
  "wsl.onboarding.installNebula": "Set upp Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Nebula kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Nebula kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Nebula aftur.",
  ...
  "help.tabs.introduction": "Nebula Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Nebula ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Nebula toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (nebula.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Nebula stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Nebula inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Nebula Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Nebula ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Nebula",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Nebula sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Nebula fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Nebula er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Nebula byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Nebula.",
