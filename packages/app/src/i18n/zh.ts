...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebula 加载失败",
  "desktop.recovery.terminated": "Nebula 窗口意外终止",
  "desktop.recovery.unresponsive": "Nebula 未响应",
  ...
  "desktop.wsl.error.installNebula": "Nebula 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.nebulaMissing": "此发行版中未安装 nebula",
  "desktop.wsl.error.nebulaCannotRun": "已安装 nebula，但无法运行",
  "desktop.wsl.error.nebulaNotInstalled": "{{distro}} 中未安装 Nebula",
  "desktop.wsl.error.updateVersion":
    "Nebula 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.nebula.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.nebula.tagline": "可靠的优化模型",
  "dialog.provider.nebulaGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Nebula 中使用 {{provider}} 模型。",
  ...
  "provider.connect.nebulaZen.line1": "Nebula Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.nebulaZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.nebulaZen.visit.prefix": "访问 ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Nebula 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Nebula 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 nebula.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Nebula 服务器。",
  ...
  "wsl.onboarding.checkingNebula": "正在检查 Nebula...",
  "wsl.onboarding.checkingNebulaIn": "正在检查 {{distro}} 中的 Nebula...",
  "wsl.onboarding.updatingNebula": "正在更新 Nebula...",
  "wsl.onboarding.updatingNebulaIn": "正在更新 {{distro}} 中的 Nebula...",
  "wsl.onboarding.updateNebulaIn": "更新 {{distro}} 中的 Nebula。",
  "wsl.onboarding.updateNebula": "更新 Nebula",
  "wsl.onboarding.nebulaReadyIn": "{{distro}} 中的 Nebula 已就绪。",
  "wsl.onboarding.nebulaReady": "Nebula 已就绪。",
  "wsl.onboarding.installNebulaIn": "在 {{distro}} 中安装 Nebula。",
  "wsl.onboarding.installNebula": "安装 Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "未安装 Nebula",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Nebula 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Nebula 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Nebula。",
  ...
  "help.tabs.introduction": "Nebula Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Nebula 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (nebula.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Nebula 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Nebula 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Nebula 服务器。",
  ...
  "settings.general.row.language.description": "更改 Nebula 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Nebula 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Nebula 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Nebula 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Nebula 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Nebula。",
