export const dict = {
  ...
  "desktop.menu.documentation": "Nebula Документација",
  ...
  "desktop.menu.ariaLabel": "Nebula мени",
  ...
  "desktop.recovery.loadFailed": "Nebula не успеа да се вчита",
  "desktop.recovery.terminated": "Прозорецот Nebula неочекувано заврши",
  "desktop.recovery.unresponsive": "Nebula не реагира",
  ...
  "desktop.wsl.error.installNebula": "инсталацијата Nebula не успеа",
  "desktop.wsl.error.alreadyAdded": "{{distro}} е веќе додаден",
  "desktop.wsl.error.nebulaMissing": "nebula не е инсталиран во оваа дистрибуција",
  "desktop.wsl.error.nebulaCannotRun": "nebula е инсталиран, но не може да се изврши",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula не е инсталиран во {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula ажурирањето е завршено, но {{distro}} сè уште известува {{installed}}; се очекува {{expected}}",
  ...
  "dialog.provider.nebula.note": "Курирани модели вклучувајќи Claude, GPT, Gemini и повеќе",
  "dialog.provider.nebula.tagline": "Сигурни оптимизирани модели",
  "dialog.provider.nebulaGo.tagline": "Ниска цена претплата за секого",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатни модели обезбедени од Nebula",
  ...
  "provider.connect.apiKey.description":
    "Внесете го вашиот клуч {{provider}} API за да ја поврзете вашата сметка и да користите {{provider}} модели во Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen ви дава пристап до куриран сет на сигурни оптимизирани модели за агенти за кодирање.",
  "provider.connect.nebulaZen.line2":
    "Со еден клуч API ќе добиете пристап до модели како што се Claude, GPT, Gemini, GLM и повеќе.",
  "provider.connect.nebulaZen.visit.prefix": "Посетете",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": "да го соберете вашиот клуч API.",
  "provider.connect.oauth.code.visit.prefix": "Посетете",
  "provider.connect.oauth.code.visit.link": "оваа врска",
  "provider.connect.oauth.code.visit.suffix":
    "да го соберете вашиот код за авторизација за да ја поврзете вашата сметка и да користите {{provider}} модели во Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "и внесете го кодот подолу за да ја поврзете вашата сметка и да користите {{provider}} модели во Nebula.",
  ...
  "dialog.plugins.empty": "Приклучоци конфигурирани во nebula.json",
  ...
  "dialog.server.description": "Променете на кој Nebula сервер се поврзува оваа апликација.",
  ...
  "wsl.onboarding.checkingNebula": "Се проверува Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Се проверува Nebula во {{distro}}...",
  "wsl.onboarding.updatingNebula": "Се ажурира Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Се ажурира Nebula во {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Ажурирајте Nebula во {{distro}}.",
  "wsl.onboarding.updateNebula": "Ажурирај Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula е подготвен во {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula е подготвен.",
  "wsl.onboarding.installNebulaIn": "Инсталирајте Nebula во {{distro}}.",
  "wsl.onboarding.installNebula": "Инсталирај Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula не е инсталиран",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) е потребно пред Nebula да може да додаде WSL сервер",
  "wsl.onboarding.wslUnavailable.title": "WSL недостапен",
  "wsl.onboarding.wslUnavailable.description": "Nebula не можеше да го потврди WSL на оваа машина.",
  "wsl.onboarding.installWsl": "Инсталирај WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Рестартирајте го Windows за да завршите со инсталирањето WSL, а потоа повторно отворете Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop сега е изграден околу картичките.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новата верзија на Nebula ({{version}}) сега е достапна за инсталирање.",
  ...
  "error.page.report.prefix": "Ве молиме пријавете ја оваа грешка на тимот Nebula",
  ...
  "error.chain.checkConfig": "Проверете ги имињата на давателот/моделот за конфигурација (nebula.json).",
  "error.chain.mcpFailed":
    "MCP серверот „{{name}}“ не успеа. Забелешка, Nebula сè уште не поддржува автентикација MCP.",
  ...
  "sidebar.gettingStarted.line1": "Nebula вклучува бесплатни модели за да можете веднаш да започнете.",
  ...
  "settings.desktop.wsl.description": "Стартувај го серверот Nebula во WSL на Windows.",
  ...
  "settings.general.row.language.description": "Променете го јазикот на прикажување за Nebula",
  ...
  "settings.general.row.appearance.description": "Приспособете како изгледа Nebula на вашиот уред",
  "settings.general.row.colorScheme.title": "Шема на бои",
  "settings.general.row.colorScheme.description": "Изберете дали Nebula ја следи системската, светла или темна тема",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Приспособете како Nebula е тематизирана.",
  ...
  "settings.updates.row.startup.description": "Автоматски проверувајте дали има ажурирања кога ќе се стартува Nebula",
  ...
  "settings.updates.toast.latest.description": "Ја извршувате најновата верзија на Nebula.",
