export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Nebula",
  "desktop.recovery.terminated": "توقفت نافذة Nebula بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Nebula لا يستجيب",
  ...
  "desktop.wsl.error.installNebula": "فشل تثبيت Nebula",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.nebulaMissing": "nebula غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.nebulaCannotRun": "nebula مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Nebula، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.nebula.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.nebula.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.nebulaGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Nebula",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "يمنحك Nebula Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "قم بزيارة ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Nebula.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في nebula.json",
  ...
  "dialog.server.description": "تبديل خادم Nebula الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingNebula": "جارٍ التحقق من Nebula...",
  "wsl.onboarding.checkingNebulaIn": "جارٍ التحقق من Nebula في {{distro}}...",
  "wsl.onboarding.updatingNebula": "جارٍ تحديث Nebula...",
  "wsl.onboarding.updatingNebulaIn": "جارٍ تحديث Nebula في {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "حدّث Nebula في {{distro}}.",
  "wsl.onboarding.updateNebula": "تحديث Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula جاهز في {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula جاهز.",
  "wsl.onboarding.installNebulaIn": "ثبّت Nebula في {{distro}}.",
  "wsl.onboarding.installNebula": "تثبيت Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Nebula من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Nebula التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Nebula.",
  ...
  "help.tabs.introduction": "أصبح Nebula Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Nebula ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Nebula",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (nebula.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Nebula لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Nebula نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Nebula داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Nebula",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Nebula على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Nebula يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Nebula.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Nebula",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Nebula.",
