...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebula yüklenemedi",
  "desktop.recovery.terminated": "Nebula penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Nebula yanıt vermiyor",
  ...
  "desktop.wsl.error.installNebula": "Nebula kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.nebulaMissing": "nebula bu dağıtımda kurulu değil",
  "desktop.wsl.error.nebulaCannotRun": "nebula kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Nebula güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.nebula.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.nebula.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.nebulaGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Nebula'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.nebulaZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Nebula'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Nebula'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler nebula.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Nebula sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula kontrol ediliyor...",
  "wsl.onboarding.checkingNebulaIn": "{{distro}} içinde Nebula kontrol ediliyor...",
  "wsl.onboarding.updatingNebula": "Nebula güncelleniyor...",
  "wsl.onboarding.updatingNebulaIn": "{{distro}} içinde Nebula güncelleniyor...",
  "wsl.onboarding.updateNebulaIn": "{{distro}} içindeki Nebula'u güncelleyin.",
  "wsl.onboarding.updateNebula": "Nebula'u güncelle",
  "wsl.onboarding.nebulaReadyIn": "{{distro}} içinde Nebula hazır.",
  "wsl.onboarding.nebulaReady": "Nebula hazır.",
  "wsl.onboarding.installNebulaIn": "Nebula'u {{distro}} içine kurun.",
  "wsl.onboarding.installNebula": "Nebula'u kur",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Nebula'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Nebula bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Nebula'u tekrar açın.",
  ...
  "help.tabs.introduction": "Nebula Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Nebula ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (nebula.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Nebula henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Nebula ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Nebula Masaüstü",
  ...
  "settings.desktop.wsl.description": "Nebula sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Nebula'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Nebula'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Nebula'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Nebula'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Nebula başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Nebula'un en son sürümünü kullanıyorsunuz.",
