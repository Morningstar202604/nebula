export const dict = {
  ...
  "dialog.provider.nebula.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.nebula.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.nebulaGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebulan tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Nebulassa.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Avaa ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Nebulassa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Nebulassa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään nebula.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Nebula-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingNebula": "Tarkistetaan Nebulaa...",
  "wsl.onboarding.checkingNebulaIn": "Tarkistetaan Nebulaa kohteessa {{distro}}...",
  "wsl.onboarding.updatingNebula": "Päivitetään Nebulaa...",
  "wsl.onboarding.updatingNebulaIn": "Päivitetään Nebulaa kohteessa {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Päivitä Nebula jakelussa {{distro}}.",
  "wsl.onboarding.updateNebula": "Päivitä Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula on valmis jakelussa {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula on valmis.",
  "wsl.onboarding.installNebulaIn": "Asenna Nebula jakeluun {{distro}}.",
  "wsl.onboarding.installNebula": "Asenna Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebulaa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Nebula voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Nebula ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Nebula uudelleen.",
  ...
  "toast.update.description": "Nebulan uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Nebula-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (nebula.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Nebula ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Nebula sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Nebula-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Nebulan näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Nebula näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Nebula järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Nebulan teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Nebula käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Nebulan uusinta versiota.",
  ...
  "desktop.menu.documentation": "Nebula-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Nebula-valikko",
  ...
  "desktop.recovery.loadFailed": "Nebulan lataaminen epäonnistui",
  "desktop.recovery.terminated": "Nebula-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Nebula ei vastaa",
  ...
  "desktop.wsl.error.installNebula": "Nebulan asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.nebulaMissing": "nebulaa ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.nebulaCannotRun": "nebula on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.nebulaNotInstalled": "Nebulaa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebulan päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Nebula Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
