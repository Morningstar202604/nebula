export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Nebula",
  ...
  "desktop.menu.ariaLabel": "Nebula meni",
  ...
  "desktop.recovery.loadFailed": "Nebula se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Nebula-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Nebula ne reaguje",
  ...
  "desktop.wsl.error.installNebula": "Instalacija Nebula-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.nebulaMissing": "nebula nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.nebulaCannotRun": "nebula je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Nebula-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.nebula.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nebula.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.nebulaGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Nebula",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Nebula-u.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.nebulaZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.nebulaZen.visit.prefix": "Posjeti ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Nebula-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Nebula-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u nebula.json",
  ...
  "dialog.server.description": "Promijeni na koji se Nebula server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingNebula": "Provjera Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Provjera Nebula u distribuciji {{distro}}...",
  "wsl.onboarding.updatingNebula": "Ažuriranje Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Ažuriranje Nebula u distribuciji {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Ažuriraj Nebula u distribuciji {{distro}}.",
  "wsl.onboarding.updateNebula": "Ažuriraj Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula je spreman.",
  "wsl.onboarding.installNebulaIn": "Instaliraj Nebula u distribuciji {{distro}}.",
  "wsl.onboarding.installNebula": "Instaliraj Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Nebula mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Nebula nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Nebula-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Nebula timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (nebula.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Nebula još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Nebula uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Nebula server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Nebula-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Nebula izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Nebula prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Nebula-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Nebula pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Nebula-a.",
