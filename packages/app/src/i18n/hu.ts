...
const desktop = [
  ...
  "Kilépés",
  "Az Nebula betöltése sikertelen",
  "Az Nebula ablaka váratlanul leállt",
  "Az Nebula nem válaszol",
  ...
  "Az Nebula telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az nebula nincs telepítve ebben a disztribúcióban",
  "Az nebula telepítve van, de nem futtatható",
  "Az Nebula nincs telepítve ebben: {{distro}}",
  "Az Nebula frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.nebula.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.nebula.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.nebulaGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A Nebula ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Nebula-ben.",
  ...
  "provider.connect.nebulaZen.line1":
    "A Nebula Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Látogatás",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Nebula-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Nebula-ben.",
  ...
  "dialog.plugins.empty": "Az nebula.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Nebula szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula ellenőrzése...",
  "wsl.onboarding.checkingNebulaIn": "Nebula ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingNebula": "Nebula frissítése...",
  "wsl.onboarding.updatingNebulaIn": "Nebula frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateNebulaIn": "Frissítse a Nebula-t a {{distro}}-ben.",
  "wsl.onboarding.updateNebula": "Frissítse a Nebula-t",
  "wsl.onboarding.nebulaReadyIn": "A Nebula készen áll a {{distro}}-ben.",
  "wsl.onboarding.nebulaReady": "A Nebula készen áll.",
  "wsl.onboarding.installNebulaIn": "Telepítse a Nebula-t a {{distro}}-be.",
  "wsl.onboarding.installNebula": "Telepítse a Nebula-t",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "A Nebula nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Nebula hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Nebula nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Nebula programot.",
  ...
  "help.tabs.introduction": "A Nebula Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Nebula ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Nebula csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (nebula.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Nebula még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Nebula ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Nebula asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Nebula szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Nebula kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Nebula az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Nebula a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Nebula témáját.",
  ...
  "settings.updates.row.startup.description": "A Nebula indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Nebula legújabb verzióját futtatja.",
