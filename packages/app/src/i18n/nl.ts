export const dict = {
  ...
  "desktop.menu.documentation": "Nebula-documentatie",
  ...
  "desktop.recovery.loadFailed": "Nebula kan niet worden geladen",
  "desktop.recovery.terminated": "Het Nebula-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Nebula reageert niet",
  ...
  "desktop.wsl.error.installNebula": "Installatie van Nebula is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.nebulaMissing": "nebula is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.nebulaCannotRun": "nebula is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Nebula-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.nebula.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.nebula.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.nebulaGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Nebula",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Nebula te gebruiken.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.nebulaZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.nebulaZen.visit.prefix": "Ga naar ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Nebula te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Nebula te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in nebula.json",
  ...
  "dialog.server.description": "Wijzig met welke Nebula-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula controleren...",
  "wsl.onboarding.checkingNebulaIn": "Nebula controleren in {{distro}}...",
  "wsl.onboarding.updatingNebula": "Nebula bijwerken...",
  "wsl.onboarding.updatingNebulaIn": "Nebula bijwerken in {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Werk Nebula bij in {{distro}}.",
  "wsl.onboarding.updateNebula": "Nebula bijwerken",
  "wsl.onboarding.nebulaReadyIn": "Nebula is gereed in {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula is klaar.",
  "wsl.onboarding.installNebulaIn": "Installeer Nebula in {{distro}}.",
  "wsl.onboarding.installNebula": "Installeer Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Nebula een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Nebula kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Nebula opnieuw.",
  ...
  "help.tabs.introduction": "Nebula Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Nebula ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Nebula-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (nebula.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Nebula ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Nebula bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Nebula-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Nebula",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Nebula eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Nebula het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Nebula aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Nebula wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Nebula is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Nebula.",
