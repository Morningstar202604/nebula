...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Nebula se nije uspio učitati",
  "Prozor aplikacije Nebula neočekivano je zatvoren",
  "Nebula ne reagira",
  ...
  "Instalacija aplikacije Nebula nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "nebula nije instaliran u ovoj distribuciji",
  "nebula je instaliran, ali se ne može pokrenuti",
  "Nebula nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Nebula je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.nebula.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.nebula.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.nebulaGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Nebula",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Posjetiti",
  "provider.connect.nebulaZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Nebula.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u nebula.json",
  ...
  "dialog.server.description": "Promijenite na koji se Nebula poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingNebulaIn": "Provjera Nebula u {{distro}}...",
  "wsl.onboarding.updatingNebula": "Ažuriranje Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Ažuriranje Nebula u {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Ažurirajte Nebula u {{distro}}.",
  "wsl.onboarding.updateNebula": "Ažurirajte Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula je spreman u {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula je spreman.",
  "wsl.onboarding.installNebulaIn": "Instalirajte Nebula u {{distro}}.",
  "wsl.onboarding.installNebula": "Instalirajte Nebula",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Nebula može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Nebula nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Nebula.",
  ...
  "help.tabs.introduction": "Radna površina Nebula sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Nebula ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Nebula timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (nebula.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Nebula još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Nebula uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Nebula Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Nebula poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Nebula",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Nebula izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Nebula slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Nebula tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Nebula pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Nebula.",
