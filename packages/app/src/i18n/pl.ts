export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Nebula",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Nebula",
  "desktop.recovery.terminated": "Okno Nebula zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Nebula nie odpowiada",
  ...
  "desktop.wsl.error.installNebula": "Nie udało się zainstalować Nebula",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.nebulaMissing": "Program nebula nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.nebulaCannotRun": "Program nebula jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Nebula została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.nebula.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.nebula.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.nebulaGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Nebula",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Odwiedź ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Nebula.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku nebula.json",
  ...
  "dialog.server.description": "Przełącz serwer Nebula, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingNebula": "Sprawdzanie Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Sprawdzanie Nebula w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingNebula": "Aktualizowanie Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Aktualizowanie Nebula w dystrybucji {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Zaktualizuj Nebula w dystrybucji {{distro}}.",
  "wsl.onboarding.updateNebula": "Zaktualizuj Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula jest gotowy.",
  "wsl.onboarding.installNebulaIn": "Zainstaluj Nebula w dystrybucji {{distro}}.",
  "wsl.onboarding.installNebula": "Zainstaluj Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Nebula będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Nebula nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Nebula ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Nebula",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (nebula.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Nebula nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Nebula zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Nebula wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Nebula",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Nebula na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Nebula ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Nebula.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Nebula",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Nebula.",
