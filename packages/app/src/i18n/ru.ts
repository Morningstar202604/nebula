export const dict = {
  ...
  "desktop.menu.documentation": "Документация Nebula",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Nebula",
  "desktop.recovery.terminated": "Окно Nebula неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Nebula не отвечает",
  ...
  "desktop.wsl.error.installNebula": "Не удалось установить Nebula",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.nebulaMissing": "nebula не установлен в этом дистрибутиве",
  "desktop.wsl.error.nebulaCannotRun": "nebula установлен, но его не удалось запустить",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Nebula завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.provider.nebula.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.nebula.tagline": "Надёжные оптимизированные модели",
  "dialog.provider.nebulaGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Nebula",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.nebulaZen.visit.suffix": ", чтобы получить ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Посетите ",
  "provider.connect.oauth.code.visit.link": "эту ссылку",
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Nebula.",
  ...
  "dialog.plugins.empty": "Плагины настроены в nebula.json",
  ...
  "dialog.server.description": "Выберите сервер Nebula, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingNebula": "Проверка Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Проверка Nebula в {{distro}}...",
  "wsl.onboarding.updatingNebula": "Обновление Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Обновление Nebula в {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Обновите Nebula в {{distro}}.",
  "wsl.onboarding.updateNebula": "Обновить Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula в {{distro}} готов к работе.",
  "wsl.onboarding.nebulaReady": "Nebula готов к работе.",
  "wsl.onboarding.installNebulaIn": "Установите Nebula в {{distro}}.",
  "wsl.onboarding.installNebula": "Установить Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Nebula требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Nebula не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Nebula.",
  ...
  "help.tabs.introduction": "Теперь работа в Nebula Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Nebula ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Nebula",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера и модели в конфигурации (nebula.json)",
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Nebula пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Nebula включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Nebula внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Nebula",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Nebula на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Nebula системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Nebula.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Nebula",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Nebula.",
