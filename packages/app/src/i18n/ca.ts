export const dict = {
  ...
  "desktop.menu.documentation": "Nebula Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Nebula.",
  ...
  "desktop.recovery.loadFailed": "Nebula no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Nebula s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Nebula no respon",
  ...
  "desktop.wsl.error.installNebula": "La instal·lació de Nebula ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.nebulaMissing": "nebula no està instal·lat en aquesta distribució",
  "desktop.wsl.error.nebulaCannotRun": "nebula està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.nebula.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.nebula.tagline": "Models optimitzats fiables",
  "dialog.provider.nebulaGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Nebula",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.nebulaZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Nebula.",
  ...
  "dialog.plugins.empty": "Connectors configurats a nebula.json",
  ...
  "dialog.server.description": "Canvia a quin Nebula servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingNebula": "S'està comprovant Nebula...",
  "wsl.onboarding.checkingNebulaIn": "S'està registrant Nebula a {{distro}}...",
  "wsl.onboarding.updatingNebula": "S'està actualitzant Nebula...",
  "wsl.onboarding.updatingNebulaIn": "S'està actualitzant Nebula a {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Actualitza Nebula a {{distro}}.",
  "wsl.onboarding.updateNebula": "Actualització Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula està llest a {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula està llest.",
  "wsl.onboarding.installNebulaIn": "Instal·leu Nebula a {{distro}}.",
  "wsl.onboarding.installNebula": "Instal·la Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Nebula pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Nebula no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Nebula.",
  ...
  "help.tabs.introduction": "Nebula L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Nebula ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Nebula.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (nebula.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Nebula encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Nebula Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Nebula dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Nebula",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Nebula al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Nebula segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Nebula.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Nebula.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Nebula.",
