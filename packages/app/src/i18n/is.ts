...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Nebula",
  "Nebula-glugganum var óvænt lokað",
  "Nebula svarar ekki",
  ...
  "Uppsetning Nebula mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "nebula er ekki uppsett í þessari dreifingu",
  "nebula er uppsett en ekki var hægt að keyra það",
  "Nebula er ekki uppsett í {{distro}}",
  "Uppfærslu Nebula lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.nebula.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.nebula.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.nebulaGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Nebula",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.nebulaZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.nebulaZen.visit.prefix": "Heimsókn",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Nebula.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í nebula.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Nebula miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingNebula": "Athugar Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Athugar Nebula í {{distro}}...",
  "wsl.onboarding.updatingNebula": "Uppfærir Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Uppfærir Nebula í {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Uppfærðu Nebula í {{distro}}.",
  "wsl.onboarding.updateNebula": "Uppfærðu Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula er tilbúið í {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula er tilbúinn.",
  "wsl.onboarding.installNebulaIn": "Settu upp Nebula í {{distro}}.",
  "wsl.onboarding.installNebula": "Settu upp Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Nebula getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Nebula gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Nebula aftur.",
  ...
  "help.tabs.introduction": "Nebula Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Nebula ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Nebula teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (nebula.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Nebula styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Nebula inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Nebula skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Nebula netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Nebula",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Nebula lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Nebula fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Nebula er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Nebula ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Nebula.",
