...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebula 載入失敗",
  "desktop.recovery.terminated": "Nebula 視窗意外終止",
  "desktop.recovery.unresponsive": "Nebula 沒有回應",
  ...
  "desktop.wsl.error.installNebula": "Nebula 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.nebulaMissing": "此發行版中未安裝 nebula",
  "desktop.wsl.error.nebulaCannotRun": "已安裝 nebula，但無法執行",
  "desktop.wsl.error.nebulaNotInstalled": "{{distro}} 中未安裝 Nebula",
  "desktop.wsl.error.updateVersion":
    "Nebula 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.nebula.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.nebula.tagline": "經過最佳化的可靠模型",
  "dialog.provider.nebulaGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Nebula 中使用 {{provider}} 模型。",
  ...
  "provider.connect.nebulaZen.line1": "Nebula Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.nebulaZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.nebulaZen.visit.prefix": "造訪 ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Nebula 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Nebula 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 nebula.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Nebula 伺服器。",
  ...
  "wsl.onboarding.checkingNebula": "正在檢查 Nebula...",
  "wsl.onboarding.checkingNebulaIn": "正在檢查 {{distro}} 中的 Nebula...",
  ...
  "wsl.onboarding.nebulaReadyIn": "{{distro}} 中的 Nebula 已就緒。",
  "wsl.onboarding.nebulaReady": "Nebula 已就緒。",
  "wsl.onboarding.installNebulaIn": "在 {{distro}} 中安裝 Nebula。",
  "wsl.onboarding.installNebula": "安裝 Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "未安裝 Nebula",
  ...
  "wsl.onboarding.wslUnavailable.description": "Nebula 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Nebula。",
  ...
  "help.tabs.introduction": "Nebula Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Nebula 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (nebula.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Nebula 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Nebula 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Nebula 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Nebula 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Nebula 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Nebula 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Nebula 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Nebula 啟動時自動檢查更新",
