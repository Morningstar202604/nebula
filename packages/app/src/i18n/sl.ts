export const dict = {
  ...
  "desktop.menu.documentation": "Nebula Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Nebula ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Nebula se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Nebula se ne odziva",
  ...
  "desktop.wsl.error.installNebula": "Namestitev Nebula ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.nebulaMissing": "nebula ni nameščen v tej distribuciji",
  "desktop.wsl.error.nebulaCannotRun": "nebula je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Nebula je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.nebula.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.nebula.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.nebulaGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Nebula",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Obisk ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Nebula.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v nebula.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Nebula se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingNebula": "Preverjanje Nebula ...",
  "wsl.onboarding.checkingNebulaIn": "Preverjanje Nebula v {{distro}} ...",
  "wsl.onboarding.updatingNebula": "Posodabljanje Nebula ...",
  "wsl.onboarding.updatingNebulaIn": "Posodabljanje Nebula v {{distro}} ...",
  "wsl.onboarding.updateNebulaIn": "Posodobite Nebula v {{distro}}.",
  "wsl.onboarding.updateNebula": "Posodobite Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula je pripravljen v {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula je pripravljen.",
  "wsl.onboarding.installNebulaIn": "Namestite Nebula v {{distro}}.",
  "wsl.onboarding.installNebula": "Namestite Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Nebula doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Nebula ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Nebula ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Nebula",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (nebula.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Nebula še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Nebula znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Nebula",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Nebula izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Nebula sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Nebula.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Nebula",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Nebula.",
