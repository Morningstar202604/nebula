export const dict = {
  ...
  "desktop.menu.documentation": "Nebula Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Nebula",
  ...
  "desktop.recovery.loadFailed": "Nebula se nepodařilo načíst",
  "desktop.recovery.terminated": "Nebula okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Nebula nereaguje",
  ...
  "desktop.wsl.error.installNebula": "Nebula instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.nebulaMissing": "nebula není v této distribuci nainstalováno",
  "desktop.wsl.error.nebulaCannotRun": "nebula je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.nebula.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.nebula.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.nebulaGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Návštěva ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Nebula.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v nebula.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Nebula serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingNebula": "Kontrola Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Kontrola Nebula v {{distro}}...",
  "wsl.onboarding.updatingNebula": "Aktualizace Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Aktualizace Nebula v {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Aktualizace Nebula v {{distro}}.",
  "wsl.onboarding.updateNebula": "Aktualizovat Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula je připraveno v {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula je připraven.",
  "wsl.onboarding.installNebulaIn": "Nainstalujte Nebula do {{distro}}.",
  "wsl.onboarding.installNebula": "Instalovat Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Nebula může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Nebula nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Nebula.",
  ...
  "help.tabs.introduction": "Nebula Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Nebula ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Nebula",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (nebula.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Nebula zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Nebula uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Nebula",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Nebula na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Nebula následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Nebula.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Nebula",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Nebula.",
