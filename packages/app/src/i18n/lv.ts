export const dict = {
  ...
  "desktop.menu.documentation": "Nebula dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Nebula izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Nebula",
  "desktop.recovery.terminated": "Nebula logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Nebula neatbild",
  ...
  "desktop.wsl.error.installNebula": "Nebula instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.nebulaMissing": "nebula nav instalēts šajā distribūcijā",
  "desktop.wsl.error.nebulaCannotRun": "nebula ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.nebula.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.nebula.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.nebulaGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Nebula",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Apmeklējiet",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Nebula.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti nebula.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Nebula servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingNebula": "Pārbaudu Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Pārbaudu Nebula distribūcijā {{distro}}...",
  "wsl.onboarding.updatingNebula": "Atjauninu Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Atjauninu Nebula distribūcijā {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Atjauniniet Nebula distribūcijā {{distro}}.",
  "wsl.onboarding.updateNebula": "Atjauniniet Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula ir gatavs.",
  "wsl.onboarding.installNebulaIn": "Instalējiet Nebula distribūcijā {{distro}}.",
  "wsl.onboarding.installNebula": "Instalējiet Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Nebula var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Nebula neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Nebula no jauna.",
  ...
  "help.tabs.introduction": "Nebula Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Nebula versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Nebula komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (nebula.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Nebula vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Nebula ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Nebula darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Nebula serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Nebula saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Nebula izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Nebula sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Nebula tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Nebula",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Nebula versiju.",
