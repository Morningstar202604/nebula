export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebula yüklənə bilmədi",
  "desktop.recovery.terminated": "Nebula pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Nebula cavab vermir",
  ...
  "desktop.wsl.error.installNebula": "Nebula quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.nebulaMissing": "Bu distribütivdə nebula quraşdırılmayıb",
  "desktop.wsl.error.nebulaCannotRun": "nebula quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Nebula yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.nebula.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.nebula.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.nebulaGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Nebula-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  "provider.connect.nebulaZen.line2":
    "Tək bir API açarı ilə Claude, GPT, Gemini, GLM və daha çox modellərə giriş əldə edəcəksiniz.",
  "provider.connect.nebulaZen.visit.prefix": "",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Nebula-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Nebula-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər nebula.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Nebula serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula yoxlanılır...",
  "wsl.onboarding.checkingNebulaIn": "{{distro}}-də Nebula yoxlanılır...",
  "wsl.onboarding.updatingNebula": "Nebula yenilənir...",
  "wsl.onboarding.updatingNebulaIn": "{{distro}}-də Nebula yenilənir...",
  "wsl.onboarding.updateNebulaIn": "{{distro}}-də Nebula-u yeniləyin.",
  "wsl.onboarding.updateNebula": "Nebula-u yeniləyin",
  "wsl.onboarding.nebulaReadyIn": "Nebula {{distro}}-də hazırdır.",
  "wsl.onboarding.nebulaReady": "Nebula hazırdır.",
  "wsl.onboarding.installNebulaIn": "Nebula-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installNebula": "Nebula quraşdırın",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Nebula WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Nebula bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Nebula-u yenidən açın.",
  ...
  "help.tabs.introduction": "Nebula Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Nebula komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (nebula.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Nebula hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Nebula-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Nebula serverini işlət.",
  ...
  "settings.general.row.language.description": "Nebula üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Nebula-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Nebula-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Nebula-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Nebula açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Nebula-un ən son versiyasından istifadə edirsiniz.",
