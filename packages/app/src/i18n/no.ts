...
export const dict = {
  ...
  "desktop.menu.documentation": "Nebula-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Nebula-meny",
  ...
  "desktop.recovery.loadFailed": "Nebula kunne ikke lastes inn",
  "desktop.recovery.terminated": "Nebula-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Nebula svarer ikke",
  ...
  "desktop.wsl.error.installNebula": "Installasjonen av Nebula mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.nebulaMissing": "nebula er ikke installert i denne distribusjonen",
  "desktop.wsl.error.nebulaCannotRun": "nebula er installert, men kunne ikke kjøres",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Nebula er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.nebula.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.nebula.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.nebulaGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Nebula",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.nebulaZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.nebulaZen.visit.prefix": "Besøk ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Nebula.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i nebula.json",
  ...
  "dialog.server.description": "Bytt hvilken Nebula-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Nebula ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Nebula-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (nebula.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Nebula ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Nebula inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Nebula-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Nebula",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Nebula ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Nebula skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Nebula.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Nebula starter",
  ...
  "settings.updates.toast.latest.title": "Nebula er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Nebula.",
  ...
  "wsl.onboarding.checkingNebula": "Sjekker Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Sjekker Nebula i {{distro}}...",
  "wsl.onboarding.updatingNebula": "Oppdaterer Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Oppdaterer Nebula i {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Oppdater Nebula i {{distro}}.",
  "wsl.onboarding.updateNebula": "Oppdater Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula er klar i {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula er klar.",
  "wsl.onboarding.installNebulaIn": "Installer Nebula i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Nebula kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Nebula kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Nebula på nytt.",
  ...
  "help.tabs.introduction": "Nebula Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
