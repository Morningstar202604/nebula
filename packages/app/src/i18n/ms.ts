export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Nebula",
  ...
  "desktop.recovery.loadFailed": "Nebula gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Nebula ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Nebula tidak memberi respons",
  ...
  "desktop.wsl.error.installNebula": "Pemasangan Nebula gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.nebulaMissing": "nebula tidak dipasang dalam distro ini",
  "desktop.wsl.error.nebulaCannotRun": "nebula dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Nebula selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.nebula.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.nebula.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.nebulaGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Nebula",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Layari",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Nebula.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam nebula.json",
  ...
  "dialog.server.description": "Tukar pelayan Nebula yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingNebula": "Sedang menyemak Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Sedang menyemak Nebula dalam {{distro}}...",
  "wsl.onboarding.updatingNebula": "Sedang mengemas kini Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Sedang mengemas kini Nebula dalam {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Kemas kini Nebula dalam {{distro}}.",
  "wsl.onboarding.updateNebula": "Kemas kini Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula sedia digunakan.",
  "wsl.onboarding.installNebulaIn": "Pasang Nebula dalam {{distro}}.",
  "wsl.onboarding.installNebula": "Pasang Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Nebula boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Nebula tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Nebula ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Nebula",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (nebula.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Nebula belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Nebula dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Nebula",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Nebula pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Nebula mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Nebula.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Nebula dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Nebula.",
