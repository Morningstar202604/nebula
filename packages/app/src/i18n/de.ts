...
export const dict = {
  ...
  "dialog.provider.nebula.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.nebula.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.nebulaGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Nebula",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Nebula zu nutzen.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Nebula zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Nebula zu nutzen.",
  ...
  "dialog.plugins.empty": "In nebula.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Nebula-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula wird geprüft…",
  "wsl.onboarding.checkingNebulaIn": "Nebula in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingNebula": "Nebula wird aktualisiert…",
  "wsl.onboarding.updatingNebulaIn": "Nebula in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateNebulaIn": "Aktualisieren Sie Nebula in {{distro}}.",
  "wsl.onboarding.updateNebula": "Nebula aktualisieren",
  "wsl.onboarding.nebulaReadyIn": "Nebula ist in {{distro}} bereit.",
  "wsl.onboarding.nebulaReady": "Nebula ist bereit.",
  "wsl.onboarding.installNebulaIn": "Installieren Sie Nebula in {{distro}}.",
  "wsl.onboarding.installNebula": "Nebula installieren",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Nebula einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Nebula konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Nebula erneut.",
  ...
  "toast.update.description": "Eine neue Version von Nebula ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Nebula-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (nebula.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Nebula unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Nebula mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Nebula enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Nebula Desktop",
  ...
  "settings.desktop.wsl.description": "Nebula-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Nebula ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Nebula auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Nebula dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Nebula anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Nebula automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Nebula ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Nebula wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Nebula konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Nebula-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Nebula reagiert nicht",
  ...
  "desktop.wsl.error.installNebula": "Nebula-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.nebulaMissing": "nebula ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.nebulaCannotRun": "nebula ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Nebula-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Nebula Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
