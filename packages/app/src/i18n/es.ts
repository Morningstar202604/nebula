export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Nebula",
  ...
  "desktop.menu.ariaLabel": "Menú de Nebula",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Nebula",
  "desktop.recovery.terminated": "La ventana de Nebula se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Nebula no responde",
  ...
  "desktop.wsl.error.installNebula": "No se pudo instalar Nebula",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.nebulaMissing": "nebula no está instalado en esta distribución",
  "desktop.wsl.error.nebulaCannotRun": "nebula está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Nebula finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.nebula.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.nebula.tagline": "Modelos optimizados y fiables",
  "dialog.provider.nebulaGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Nebula",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.nebulaZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Nebula.",
  ...
  "dialog.plugins.empty": "Plugins configurados en nebula.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Nebula al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingNebula": "Comprobando Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Comprobando Nebula en {{distro}}...",
  "wsl.onboarding.updatingNebula": "Actualizando Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Actualizando Nebula en {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Actualiza Nebula en {{distro}}.",
  "wsl.onboarding.updateNebula": "Actualizar Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula está listo en {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula está listo.",
  "wsl.onboarding.installNebulaIn": "Instala Nebula en {{distro}}.",
  "wsl.onboarding.installNebula": "Instalar Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Nebula pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Nebula no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Nebula ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Nebula",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (nebula.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Nebula aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Nebula dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Nebula",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Nebula en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Nebula sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Nebula.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Nebula",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Nebula.",
