export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebulaを読み込めませんでした",
  "desktop.recovery.terminated": "Nebulaのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Nebulaが応答していません",
  ...
  "desktop.wsl.error.installNebula": "Nebulaのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.nebulaMissing": "このディストリビューションにはnebulaがインストールされていません",
  "desktop.wsl.error.nebulaCannotRun": "nebulaはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.nebulaNotInstalled": "{{distro}}にはNebulaがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Nebulaのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.nebula.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.nebula.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.nebulaGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebulaが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Nebulaで{{provider}}モデルを使用します。",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.nebulaZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.nebulaZen.visit.prefix": " ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNebulaで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Nebulaで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "nebula.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するNebulaサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingNebula": "Nebulaを確認中...",
  "wsl.onboarding.checkingNebulaIn": "{{distro}}内のNebulaを確認中...",
  "wsl.onboarding.updatingNebula": "Nebulaを更新中...",
  "wsl.onboarding.updatingNebulaIn": "{{distro}}内のNebulaを更新中...",
  "wsl.onboarding.updateNebulaIn": "{{distro}}内のNebulaを更新してください。",
  "wsl.onboarding.updateNebula": "Nebulaを更新",
  "wsl.onboarding.nebulaReadyIn": "{{distro}}内のNebulaの準備ができました。",
  "wsl.onboarding.nebulaReady": "Nebulaの準備ができました。",
  "wsl.onboarding.installNebulaIn": "{{distro}}にNebulaをインストールしてください。",
  "wsl.onboarding.installNebula": "Nebulaをインストール",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebulaがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NebulaでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Nebulaをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Nebula Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebulaの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNebulaチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (nebula.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NebulaはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Nebulaには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNebulaサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Nebulaの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNebulaの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Nebulaがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Nebulaのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Nebula の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Nebula は最新バージョンです。",
