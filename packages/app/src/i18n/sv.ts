export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebula kunde inte läsas in",
  "desktop.recovery.terminated": "Nebula-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Nebula svarar inte",
  ...
  "desktop.wsl.error.installNebula": "Installationen av Nebula misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.nebulaMissing": "nebula är inte installerat i den här distributionen",
  "desktop.wsl.error.nebulaCannotRun": "nebula är installerat men kunde inte köras",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.nebula.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.nebula.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.nebulaGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Nebula",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.nebulaZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.nebulaZen.visit.prefix": "Besök ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Nebula.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i nebula.json",
  ...
  "dialog.server.description": "Växla vilken Nebula-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingNebula": "Kontrollerar Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Kontrollerar Nebula i {{distro}}...",
  "wsl.onboarding.updatingNebula": "Uppdaterar Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Uppdaterar Nebula i {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Uppdatera Nebula i {{distro}}.",
  "wsl.onboarding.updateNebula": "Uppdatera Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula är redo i {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula är redo.",
  "wsl.onboarding.installNebulaIn": "Installera Nebula i {{distro}}.",
  "wsl.onboarding.installNebula": "Installera Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Nebula kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Nebula kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Nebula igen.",
  ...
  "help.tabs.introduction": "Nebula Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Nebula ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Nebula-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (nebula.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Nebula stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Nebula innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Nebula-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Nebula",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Nebula ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Nebula följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Nebulas tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Nebula startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Nebula.",
