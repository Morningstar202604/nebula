export const dict = {
  ...
  "dialog.provider.nebula.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.nebula.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.nebulaGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Nebula",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.nebulaZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.nebulaZen.visit.prefix": "Besøg ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Nebula.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i nebula.json",
  ...
  "dialog.server.description": "Skift hvilken Nebula-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingNebula": "Tjekker Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Tjekker Nebula i {{distro}}...",
  "wsl.onboarding.updatingNebula": "Opdaterer Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Opdaterer Nebula i {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Opdater Nebula i {{distro}}.",
  "wsl.onboarding.updateNebula": "Opdater Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Nebula kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Nebula kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Nebula igen.",
  ...
  "toast.update.description": "En ny version af Nebula ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Nebula-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (nebula.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Nebula understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Nebula inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Nebula-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Nebula",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Nebula ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Nebula skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Nebulas tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Nebula starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Nebula.",
  ...
  "desktop.recovery.loadFailed": "Nebula kunne ikke indlæses",
  "desktop.recovery.terminated": "Nebula-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installNebula": "Installationen af Nebula mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.nebulaMissing": "nebula er ikke installeret i denne distribution",
  "desktop.wsl.error.nebulaCannotRun": "nebula er installeret, men kunne ikke køre",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Nebula er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Nebula Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
