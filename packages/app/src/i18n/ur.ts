export const dict = {
  ...
  "desktop.menu.documentation": "Nebula دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Nebula مینو",
  ...
  "desktop.recovery.loadFailed": "Nebula لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Nebula ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Nebula جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installNebula": "Nebula کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.nebulaMissing": "اس ڈسٹری بیوشن میں nebula انسٹال نہیں ہے",
  "desktop.wsl.error.nebulaCannotRun": "nebula انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.nebulaNotInstalled": "{{distro}} میں Nebula انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Nebula کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.nebula.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.nebula.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.nebulaGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Nebula میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.nebulaZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.nebulaZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Nebula میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Nebula میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "nebula.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Nebula سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingNebula": "Nebula چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingNebulaIn": "{{distro}} میں Nebula چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingNebula": "Nebula کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingNebulaIn": "{{distro}} میں Nebula کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateNebulaIn": "{{distro}} میں Nebula کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateNebula": "Nebula کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.nebulaReadyIn": "Nebula {{distro}} میں تیار ہے۔",
  "wsl.onboarding.nebulaReady": "Nebula تیار ہے۔",
  "wsl.onboarding.installNebulaIn": "{{distro}} میں Nebula انسٹال کریں۔",
  "wsl.onboarding.installNebula": "Nebula انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Nebula WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Nebula اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Nebula کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Nebula Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Nebula ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (nebula.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Nebula ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Nebula میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Nebula ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Nebula سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Nebula کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Nebula کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Nebula سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Nebula کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Nebula لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Nebula کا تازہ ترین ورژن چلا رہے ہیں۔",
