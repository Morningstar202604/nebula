export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Nebula",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Nebula",
  "desktop.recovery.terminated": "La fenêtre Nebula s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Nebula ne répond pas",
  ...
  "desktop.wsl.error.installNebula": "Échec de l'installation d'Nebula",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.nebulaMissing": "nebula n'est pas installé dans cette distribution",
  "desktop.wsl.error.nebulaCannotRun": "nebula est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Nebula est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.nebula.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.nebula.tagline": "Modèles optimisés et fiables",
  "dialog.provider.nebulaGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Nebula",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Visitez ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Nebula.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans nebula.json",
  ...
  "dialog.server.description": "Changez le serveur Nebula auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingNebula": "Vérification d'Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Vérification d'Nebula dans {{distro}}...",
  "wsl.onboarding.updatingNebula": "Mise à jour d'Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Mise à jour d'Nebula dans {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Mettez à jour Nebula dans {{distro}}.",
  "wsl.onboarding.updateNebula": "Mettre à jour Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula est prêt dans {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula est prêt.",
  "wsl.onboarding.installNebulaIn": "Installez Nebula dans {{distro}}.",
  "wsl.onboarding.installNebula": "Installer Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Nebula puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Nebula n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Nebula ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Nebula",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (nebula.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Nebula ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Nebula inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Nebula dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Nebula",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Nebula sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Nebula suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Nebula.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Nebula",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Nebula.",
