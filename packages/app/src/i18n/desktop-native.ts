...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Nebula failed to load",
  "desktop.recovery.terminated": "Nebula window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Nebula is not responding",
  ...
  "desktop.wsl.error.installNebula": "Nebula installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.nebulaMissing": "nebula is not installed in this distro",
  "desktop.wsl.error.nebulaCannotRun": "nebula is installed but could not run",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
