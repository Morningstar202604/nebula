export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebula laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Nebula aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Nebula ei vasta",
  ...
  "desktop.wsl.error.installNebula": "Nebula installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.nebulaMissing": "nebula pole sellesse distrosse installitud",
  "desktop.wsl.error.nebulaCannotRun": "nebula on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Nebula värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.nebula.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.nebula.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.nebulaGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Nebula",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Nebula'is.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Külastage ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Nebula.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis nebula.json",
  ...
  "dialog.server.description": "Lülitage, millise Nebula serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula kontrollimine...",
  "wsl.onboarding.checkingNebulaIn": "Nebula kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingNebula": "Nebula värskendamine...",
  "wsl.onboarding.updatingNebulaIn": "Nebula värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Värskenda Nebula jaotises {{distro}}.",
  "wsl.onboarding.updateNebula": "Värskenda Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula on valmis {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula on valmis.",
  "wsl.onboarding.installNebulaIn": "Installige Nebula asukohta {{distro}}.",
  "wsl.onboarding.installNebula": "Installige Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Nebula saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Nebula ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Nebula.",
  ...
  "help.tabs.introduction": "Nebula Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Nebula ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Nebula meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (nebula.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Nebula ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Nebula sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Nebula Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Nebula server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Nebula kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Nebula teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Nebula järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Nebula on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Nebula käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Nebula uusimat versiooni.",
