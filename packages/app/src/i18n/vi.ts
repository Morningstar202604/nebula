export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Nebula",
  ...
  "desktop.recovery.loadFailed": "Không tải được Nebula",
  "desktop.recovery.terminated": "Cửa sổ Nebula đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Nebula không phản hồi",
  ...
  "desktop.wsl.error.installNebula": "Không cài đặt được Nebula",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.nebulaMissing": "nebula chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.nebulaCannotRun": "nebula đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Nebula nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.nebula.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.nebula.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.nebulaGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Nebula cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Truy cập ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Nebula.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong nebula.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Nebula mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingNebula": "Đang kiểm tra Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Đang kiểm tra Nebula trong {{distro}}...",
  "wsl.onboarding.updatingNebula": "Đang cập nhật Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Đang cập nhật Nebula trong {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Cập nhật Nebula trong {{distro}}.",
  "wsl.onboarding.updateNebula": "Cập nhật Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula đã sẵn sàng.",
  "wsl.onboarding.installNebulaIn": "Cài đặt Nebula trong {{distro}}.",
  "wsl.onboarding.installNebula": "Cài đặt Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Nebula có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Nebula không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Nebula ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Nebula",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (nebula.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Nebula chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Nebula bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Nebula",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Nebula trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Nebula tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Nebula.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Nebula khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Nebula.",
