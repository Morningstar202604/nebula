export const dict = {
  ...
  "dialog.provider.nebula.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.nebula.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.nebulaGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Nebula",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.nebulaZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.nebulaZen.visit.prefix": "Visita ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Nebula.",
  ...
  "dialog.plugins.empty": "Plugin configurati in nebula.json",
  ...
  "dialog.server.description": "Cambia il server Nebula a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingNebula": "Controllo Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Controllo Nebula in {{distro}}...",
  "wsl.onboarding.updatingNebula": "Aggiornamento Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Aggiornamento Nebula in {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Aggiorna Nebula in {{distro}}.",
  "wsl.onboarding.updateNebula": "Aggiorna Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula è pronto in {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula è pronto.",
  "wsl.onboarding.installNebulaIn": "Installa Nebula in {{distro}}.",
  "wsl.onboarding.installNebula": "Installa Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Nebula possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Nebula non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Nebula ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Nebula",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (nebula.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Nebula non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Nebula all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Nebula",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Nebula sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Nebula segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Nebula.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Nebula",
  ...
  "settings.updates.toast.latest.title": "Nebula è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Nebula.",
  ...
  "desktop.menu.documentation": "Documentazione di Nebula",
  ...
  "desktop.menu.ariaLabel": "Menu Nebula",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Nebula",
  "desktop.recovery.terminated": "La finestra di Nebula si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Nebula non risponde",
  ...
  "desktop.wsl.error.installNebula": "Installazione di Nebula non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.nebulaMissing": "nebula non è installato in questa distribuzione",
  "desktop.wsl.error.nebulaCannotRun": "nebula è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Nebula è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
