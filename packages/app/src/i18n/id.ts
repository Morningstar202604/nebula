export const dict = {
  ...
  "desktop.recovery.loadFailed": "Nebula gagal dimuat",
  "desktop.recovery.terminated": "Jendela Nebula berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Nebula tidak merespons",
  ...
  "desktop.wsl.error.installNebula": "Instalasi Nebula gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.nebulaMissing": "nebula belum terinstal di distro ini",
  "desktop.wsl.error.nebulaCannotRun": "nebula telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Nebula selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.nebula.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.nebula.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.nebulaGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Nebula",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Nebula.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di nebula.json",
  ...
  "dialog.server.description": "Ganti server Nebula mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingNebula": "Memeriksa Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Memeriksa Nebula di {{distro}}...",
  "wsl.onboarding.updatingNebula": "Memperbarui Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Memperbarui Nebula di {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Perbarui Nebula di {{distro}}.",
  "wsl.onboarding.updateNebula": "Perbarui Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula siap di {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula siap.",
  "wsl.onboarding.installNebulaIn": "Instal Nebula di {{distro}}.",
  "wsl.onboarding.installNebula": "Instal Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Nebula dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Nebula tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Nebula ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Nebula",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (nebula.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Nebula belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Nebula di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Nebula",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Nebula di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Nebula mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Nebula diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Nebula.",
