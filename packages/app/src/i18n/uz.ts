export const dict = {
  ...
  "desktop.menu.documentation": "Nebula hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Nebula menyusi",
  ...
  "desktop.recovery.loadFailed": "Nebula yuklanmadi",
  "desktop.recovery.terminated": "Nebula oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Nebula javob bermayapti",
  ...
  "desktop.wsl.error.installNebula": "Nebula oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.nebulaMissing": "Nebula ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.nebulaCannotRun": "nebula o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Nebula yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.nebula.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.nebula.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.nebulaGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Nebula’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Nebula da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Nebula da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "nebula.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Nebula serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula tekshirilmoqda...",
  "wsl.onboarding.checkingNebulaIn": "Nebula {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingNebula": "Nebula yangilanmoqda...",
  "wsl.onboarding.updatingNebulaIn": "Nebula {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateNebulaIn": "Nebula-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateNebula": "Nebula-ni yangilang",
  "wsl.onboarding.nebulaReadyIn": "Nebula {{distro}} da tayyor.",
  "wsl.onboarding.nebulaReady": "Nebula tayyor.",
  "wsl.onboarding.installNebulaIn": "Nebula-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installNebula": "Nebula-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Nebula WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Nebula WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Nebula-ni qayta oching.",
  ...
  "help.tabs.introduction": "Nebula Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Nebula jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (nebula.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Nebula hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Nebula bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Nebula serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Nebula uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Nebula qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Nebula tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Nebula mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Nebula ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Nebula oxirgi versiyasini ishga tushiryapsiz.",
