...
export const dict = {
  ...
  "dialog.provider.nebula.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.nebula.tagline": "Reliable optimized models",
  "dialog.provider.nebulaGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Nebula",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Nebula.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.nebulaZen.line1":
    "Nebula Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.nebulaZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.nebulaZen.visit.prefix": "Visit ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Nebula.",
  ...
  "dialog.plugins.empty": "Plugins configured in nebula.json",
  ...
  "dialog.server.description": "Switch which Nebula server this app connects to.",
  ...
  "wsl.onboarding.checkingNebula": "Checking Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Checking Nebula in {{distro}}...",
  "wsl.onboarding.updatingNebula": "Updating Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Updating Nebula in {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Update Nebula in {{distro}}.",
  "wsl.onboarding.updateNebula": "Update Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula is ready in {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula is ready.",
  "wsl.onboarding.installNebulaIn": "Install Nebula in {{distro}}.",
  "wsl.onboarding.installNebula": "Install Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Nebula can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Nebula could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Nebula ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Nebula team",
  ...
  "error.chain.checkConfig": "Check your config (nebula.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Nebula does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Nebula includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Nebula server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Nebula",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Nebula looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Nebula follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Nebula is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Nebula launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Nebula.",
