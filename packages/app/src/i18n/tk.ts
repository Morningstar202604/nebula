export const dict = {
  ...
  "desktop.menu.documentation": "Nebula Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Nebula menýusy",
  ...
  "desktop.recovery.loadFailed": "Nebula ýükläp bilmedi",
  "desktop.recovery.terminated": "Nebula penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Nebula jogap berenok",
  ...
  "desktop.wsl.error.installNebula": "Nebula gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.nebulaMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.nebulaCannotRun": "nebula guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Nebula täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.nebula.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.nebula.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.nebulaGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Nebula-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  "provider.connect.nebulaZen.line2":
    "Zekeje API açary bilen Claude, GPT, Gemini, GLM we başgalar ýaly modellere girip bilersiňiz.",
  "provider.connect.nebulaZen.visit.prefix": "Sapar ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Nebula-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Nebula-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "nebula.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Nebula serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingNebula": "Nebula barlamak ...",
  "wsl.onboarding.checkingNebulaIn": "{{distro}} içinde Nebula barlanýar...",
  "wsl.onboarding.updatingNebula": "Nebula täzelenmek ...",
  "wsl.onboarding.updatingNebulaIn": "{{distro}}-de Nebula täzelenmek ...",
  "wsl.onboarding.updateNebulaIn": "Nebula-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateNebula": "Nebula täzeläň",
  "wsl.onboarding.nebulaReadyIn": "Nebula {{distro}}-de taýýar.",
  "wsl.onboarding.nebulaReady": "Nebula taýýar.",
  "wsl.onboarding.installNebulaIn": "{{distro}}-de Nebula guruň.",
  "wsl.onboarding.installNebula": "Nebula guruň",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Nebula WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Nebula bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Nebula açyň.",
  ...
  "help.tabs.introduction": "Nebula Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Nebula ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Nebula toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (nebula.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Nebula entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Nebula mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Nebula serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Nebula üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Nebula enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Nebula ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Nebula-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Nebula işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Nebula-iň iň soňky wersiýasyny işleýärsiňiz.",
