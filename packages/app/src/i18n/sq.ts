export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Nebula",
  ...
  "desktop.menu.ariaLabel": "Menuja Nebula",
  ...
  "desktop.recovery.loadFailed": "Nebula nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Nebula u mbyll papritur",
  "desktop.recovery.unresponsive": "Nebula nuk po përgjigjet",
  ...
  "desktop.wsl.error.installNebula": "Instalimi i Nebula dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.nebulaMissing": "Nebula nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.nebulaCannotRun": "Nebula është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.nebulaNotInstalled": "Nebula nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Nebula përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.nebula.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.nebula.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.nebulaGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Nebula",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.nebulaZen.visit.prefix": "Vizitoni ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Nebula.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në nebula.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Nebula lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingNebula": "Po kontrollon Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Po kontrollon Nebula në {{distro}}...",
  "wsl.onboarding.updatingNebula": "Nebula po përditësohet...",
  "wsl.onboarding.updatingNebulaIn": "Po përditëson Nebula në {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Përditëso Nebula në {{distro}}.",
  "wsl.onboarding.updateNebula": "Përditëso Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula është gati në {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula është gati.",
  "wsl.onboarding.installNebulaIn": "Instaloni Nebula në {{distro}}.",
  "wsl.onboarding.installNebula": "Instaloni Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Nebula të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Nebula nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Nebula ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Nebula",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (nebula.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Nebula nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Nebula përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Nebula brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Nebula",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Nebula në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Nebula ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Nebula.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Nebula",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Nebula.",
