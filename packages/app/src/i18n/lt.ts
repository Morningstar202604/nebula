...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Nebula įkelti nepavyko",
  "Nebula langas netikėtai užsidarė",
  "Nebula neatsako",
  ...
  "Nebula įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "nebula šiame distributyve neįdiegtas",
  "nebula įdiegtas, bet jo paleisti nepavyko",
  "Nebula neįdiegtas distributyve {{distro}}",
  "Nebula naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.nebula.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.nebula.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.nebulaGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Nebula modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Nebula.",
  ...
  "provider.connect.nebulaZen.line1":
    "Nebula Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.nebulaZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.nebulaZen.visit.prefix": "Aplankykite",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Nebula.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Nebula.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti nebula.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Nebula serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingNebula": "Tikrinama Nebula...",
  "wsl.onboarding.checkingNebulaIn": "Tikrinama Nebula {{distro}}...",
  "wsl.onboarding.updatingNebula": "Atnaujinamas Nebula...",
  "wsl.onboarding.updatingNebulaIn": "Atnaujinamas Nebula {{distro}}...",
  "wsl.onboarding.updateNebulaIn": "Atnaujinkite Nebula {{distro}}.",
  "wsl.onboarding.updateNebula": "Atnaujinkite Nebula",
  "wsl.onboarding.nebulaReadyIn": "Nebula yra paruoštas {{distro}}.",
  "wsl.onboarding.nebulaReady": "Nebula yra paruoštas.",
  "wsl.onboarding.installNebulaIn": "Įdiekite Nebula į {{distro}}.",
  "wsl.onboarding.installNebula": "Įdiekite Nebula",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Nebula galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Nebula nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Nebula.",
  ...
  "help.tabs.introduction": "Nebula Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Nebula ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Nebula komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (nebula.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Nebula dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Nebula apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Nebula darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Nebula serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Nebula ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Nebula atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Nebula seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Nebula temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Nebula",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Nebula versiją.",
