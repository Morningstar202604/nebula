export const dict = {
  ...
  "desktop.menu.documentation": "Nebula دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Nebula لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Nebula دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Nebula جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installNebula": "Nebula دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.nebulaMissing": "اس ڈسٹرو وچ nebula انسٹال نئیں اے",
  "desktop.wsl.error.nebulaCannotRun": "nebula انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.nebulaNotInstalled": "{{distro}} وچ Nebula انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Nebula دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.nebula.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.nebula.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.nebulaGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Nebula دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Nebula وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.nebulaZen.visit.prefix": "ویکھو ",
  "provider.connect.nebulaZen.visit.link": "nebula.ai/zen",
  "provider.connect.nebulaZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Nebula وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Nebula وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "nebula.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Nebula سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingNebula": "Nebula چیک کر رئے آں...",
  "wsl.onboarding.checkingNebulaIn": "{{distro}} چ Nebula دی جانچ پڑتال...",
  "wsl.onboarding.updatingNebula": "Nebula نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingNebulaIn": "{{distro}} وچ Nebula نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateNebulaIn": "{{distro}} وچ Nebula نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateNebula": "Nebula اپ ڈیٹ کرو",
  "wsl.onboarding.nebulaReadyIn": "Nebula {{distro}} چ تیار اے۔",
  "wsl.onboarding.nebulaReady": "Nebula تیار اے۔",
  "wsl.onboarding.installNebulaIn": "{{distro}} وچ Nebula انسٹال کرو۔",
  "wsl.onboarding.installNebula": "Nebula انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.nebulaMissing": "Nebula انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Nebula دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Nebula ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Nebula دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Nebula Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nebula ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Nebula ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (nebula.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Nebula ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Nebula چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Nebula سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Nebula لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Nebula کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Nebula سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Nebula نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Nebula لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Nebula دا تازہ ترین ورژن چلا رئے او۔",
