...
import { ModelV2 } from "@nebula-ai/core/model"
import { SessionV2 } from "@nebula-ai/core/session"
import { Agent } from "@nebula-ai/schema/agent"
import { Location } from "@nebula-ai/schema/location"
import { Model } from "@nebula-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@nebula-ai/schema/prompt"
import { Provider } from "@nebula-ai/schema/provider"
import { Project } from "@nebula-ai/schema/project"
import { ProjectDirectories } from "@nebula-ai/schema/project-directories"
import { PermissionV1 } from "@nebula-ai/schema/permission-v1"
import { Session } from "@nebula-ai/schema/session"
import { SessionInput } from "@nebula-ai/schema/session-input"
import { SessionMessage } from "@nebula-ai/schema/session-message"
import { Workspace } from "@nebula-ai/schema/workspace"
import { Command } from "@nebula-ai/schema/command"
import { Connection } from "@nebula-ai/schema/connection"
import { Credential } from "@nebula-ai/schema/credential"
import { FileSystem } from "@nebula-ai/schema/filesystem"
import { Integration } from "@nebula-ai/schema/integration"
import { LLM } from "@nebula-ai/schema/llm"
import { Permission } from "@nebula-ai/schema/permission"
import { Plugin } from "@nebula-ai/schema/plugin"
import { Pty } from "@nebula-ai/schema/pty"
import { Reference } from "@nebula-ai/schema/reference"
import { SessionTodo } from "@nebula-ai/schema/session-todo"
import { Skill } from "@nebula-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@nebula-ai/schema/schema"
import { ProviderV2 } from "@nebula-ai/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@nebula-ai/core/command"),
    import("@nebula-ai/core/integration/connection"),
    import("@nebula-ai/core/credential"),
    import("@nebula-ai/core/filesystem"),
    import("@nebula-ai/core/integration"),
    import("@nebula-ai/core/location"),
    import("@nebula-ai/llm"),
    import("@nebula-ai/core/permission"),
    import("@nebula-ai/core/v1/permission"),
    import("@nebula-ai/core/project/copy"),
    import("@nebula-ai/core/pty"),
    import("@nebula-ai/core/project/schema"),
    import("@nebula-ai/core/reference"),
    import("@nebula-ai/core/session/input"),
    import("@nebula-ai/core/session/message"),
    import("@nebula-ai/core/session/todo"),
    import("@nebula-ai/core/session/prompt"),
    import("@nebula-ai/core/skill"),
    import("@nebula-ai/core/v2-schema"),
    import("@nebula-ai/core/schema"),
    import("@nebula-ai/core/workspace"),
  ])
