...
import { GoogleVertexPlugin } from "@nebula-ai/core/plugin/provider/google-vertex"
      ...
      yield* catalog.transform((catalog) =>
        catalog.provider.update(ProviderV2.ID.nebula, (provider) => {
          provider.api = {
            ...
            url: "https://nebula.ai/zen/v1",
          }
        }),
      )
      yield* addPlugin()

      const provider = required(yield* catalog.provider.get(ProviderV2.ID.nebula))
