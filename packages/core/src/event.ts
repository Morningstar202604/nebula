...
import type { Data, Definition, Payload } from "@nebula-ai/schema/event"
...
import { Durable } from "@nebula-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@nebula-ai/schema/event").ID
export type { Data, Definition, Payload } from "@nebula-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/Event") {}
