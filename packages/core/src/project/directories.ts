...
import type { EffectDrizzleSqlite } from "@nebula-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/ProjectDirectories") {}
