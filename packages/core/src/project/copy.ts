...
import { Event } from "@nebula-ai/schema/project-directories"
import { ProjectCopy } from "@nebula-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/ProjectCopy") {}
