...
import { FileSystemWatcher } from "@nebula-ai/schema/filesystem-watcher"
...
declare const NEBULA_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof NEBULA_LIBC === "undefined" ? undefined : NEBULA_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@nebula/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.NEBULA_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.NEBULA_EXPERIMENTAL_FILEWATCHER)) {
