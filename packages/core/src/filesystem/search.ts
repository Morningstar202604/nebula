...
export class Service extends Context.Service<Service, Interface>()("@nebula/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.NEBULA_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
