...
import { Entry, FileSystem, FindInput, Match } from "@nebula-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@nebula-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/v2/FileSystem") {}
