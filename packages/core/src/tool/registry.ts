...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@nebula-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/v2/ToolRegistry") {}
