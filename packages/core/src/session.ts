...
import { ListAnchor } from "@nebula-ai/schema/session"
...
import { SessionDurable } from "@nebula-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/v2/Session") {}
