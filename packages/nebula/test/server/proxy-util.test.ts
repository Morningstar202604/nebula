...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips nebula-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-nebula-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-nebula-directory")).toBeNull()
      expect(result.get("x-nebula-workspace")).toBeNull()
