...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips nebula-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-nebula-directory"]).toBeUndefined()
      expect(forwarded["x-nebula-workspace"]).toBeUndefined()
