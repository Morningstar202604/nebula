...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NEBULA_CALLER", () => {
    process.env["NEBULA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NEBULA_CALLER", () => {
    process.env["NEBULA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NEBULA_CALLER", () => {
    process.env["NEBULA_CALLER"] = "unknown"
