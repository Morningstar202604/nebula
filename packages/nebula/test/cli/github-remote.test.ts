...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nebula.git")).toEqual({ owner: "sst", repo: "nebula" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/nebula")).toEqual({ owner: "sst", repo: "nebula" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nebula.git")).toEqual({ owner: "sst", repo: "nebula" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/nebula")).toEqual({ owner: "sst", repo: "nebula" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nebula.git")).toEqual({ owner: "sst", repo: "nebula" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/nebula")).toEqual({ owner: "sst", repo: "nebula" })
})
