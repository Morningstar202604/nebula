...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@nebula/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@nebula/ACPDirectory") {}
