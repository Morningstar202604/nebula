...
import { AccountStateTable, AccountTable } from "@nebula-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/AccountRepo") {}
