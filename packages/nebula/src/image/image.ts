...
export class Service extends Context.Service<Service, Interface>()("@nebula/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __NEBULA_PHOTON_WASM_PATH?: string }).__NEBULA_PHOTON_WASM_PATH =
