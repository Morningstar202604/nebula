...
import { EventSequenceTable, EventTable } from "@nebula-ai/core/event/sql"
...
import { WorkspaceEvent } from "@nebula-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NEBULA_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        NEBULA_WORKSPACE_ID: config.id,
        NEBULA_EXPERIMENTAL_WORKSPACES: "true",
