...
import type * as SDK from "@nebula-ai/sdk/v2"
...
import { SessionShareTable } from "@nebula-ai/core/share/sql"
...
const disabled = process.env["NEBULA_DISABLE_SHARE"] === "true" || process.env["NEBULA_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/ShareNext") {}
