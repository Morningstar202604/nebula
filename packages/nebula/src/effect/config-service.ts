 ...
 *   "@nebula/ServerAuthConfig",
 *   {
 *     password: Config.string("NEBULA_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NEBULA_SERVER_USERNAME").pipe(Config.withDefault("nebula")),
 *   },
 * ) {}
 *
