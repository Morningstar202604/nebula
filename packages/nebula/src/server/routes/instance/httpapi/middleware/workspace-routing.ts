...
>()("@nebula/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@nebula/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.NEBULA_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.NEBULA_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-nebula-directory"] || process.cwd()
}
