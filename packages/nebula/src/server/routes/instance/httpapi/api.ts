...
import { makeApi } from "@nebula-ai/protocol/api"
import { LocationMiddleware } from "@nebula-ai/server/location"
import { SessionLocationMiddleware } from "@nebula-ai/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("nebula-root")
...
export const InstanceHttpApi = HttpApi.make("nebula-instance")
...
export const NebulaHttpApi = HttpApi.make("nebula")
