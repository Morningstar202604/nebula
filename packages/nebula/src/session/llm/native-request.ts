import type { JsonSchema, LLMRequest, ProviderMetadata } from "@nebula-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@nebula-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @nebula-ai/llm request objects from nebula's session/AI SDK-shaped data.
  return LLM.request({
