...
import { buildPrompt } from "@nebula-ai/core/session/compaction"
import { SessionCompactionEvent } from "@nebula-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/SessionCompaction") {}
