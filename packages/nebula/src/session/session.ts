...
import { Slug } from "@nebula-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@nebula-ai/llm"
...
import { locationServiceMapLayer } from "@nebula-ai/core/location-services"
...
import { PartTable, SessionTable } from "@nebula-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@nebula-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".nebula", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@nebula/Session") {}
