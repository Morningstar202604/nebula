import type { Hooks, PluginInput } from "@nebula-ai/plugin"
import type { Model } from "@nebula-ai/sdk/v2"
import { InstallationVersion } from "@nebula-ai/core/installation/version"
import { OauthCallbackPage } from "@nebula-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Nebula will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
