...
import { ProjectDirectoryTable, ProjectTable } from "@nebula-ai/core/project/sql"
import { ProjectDirectories } from "@nebula-ai/core/project/directories"
...
import { which } from "@nebula-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@nebula/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.NEBULA_FAKE_VCS)
