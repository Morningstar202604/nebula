...
import { openEditor } from "@nebula-ai/tui/editor"
import { registerNebulaKeymap } from "@nebula-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerNebulaKeymap(keymap, renderer, input.tuiConfig)
