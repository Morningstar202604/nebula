...
import type { Event, GlobalEvent, NebulaClient } from "@nebula-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@nebula/RunStreamTransport") {}
