...
import { normalizePromptContent } from "@nebula-ai/tui/editor"
...
import { NEBULA_BASE_MODE, useBindings } from "@nebula-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Nebula" } satisfies SlashOption,
    ]
