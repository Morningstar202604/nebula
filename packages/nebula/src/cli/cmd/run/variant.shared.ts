...
//
// The saved variant persists across sessions in ~/.local/state/nebula/model.json
...
class Service extends Context.Service<Service, VariantService>()("@nebula/RunVariant") {}
