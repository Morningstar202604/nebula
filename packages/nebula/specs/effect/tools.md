...
Practical reference for the current tool-migration state in `packages/nebula`.
...
Tool tests should use the existing Effect helpers in `packages/nebula/test/lib/effect.ts`:
