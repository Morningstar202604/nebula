export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Nebula Data",
  "app.description":
    "Explore o uso do Nebula em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Nebula Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Nebula no GitHub",
  "header.github": "GitHub",
  "header.tryNebula": "Experimente o Nebula",
  ...
  "footer.homeAria": "Início do Nebula",
  ...
  "modal.title": "Newsletter do Nebula",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Nebula.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Nebula por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Nebula Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Nebula, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Nebula.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Nebula",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Nebula",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Nebula nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Nebula Data",
  "model.description":
    "Veja dados de uso de {{model}} no Nebula, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Nebula aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Nebula da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Nebula da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Nebula na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Nebula, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Nebula.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Nebula na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Nebula na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Nebula.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Nebula correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Nebula.",
