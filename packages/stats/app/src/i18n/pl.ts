export const dict = {
  "app.title": "Rankingi użycia modeli AI | Nebula Data",
  "app.description":
    "Przeglądaj użycie Nebula w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Nebula Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Nebula na GitHub",
  "header.github": "GitHub",
  "header.tryNebula": "Wypróbuj Nebula",
  ...
  "footer.homeAria": "Strona główna Nebula",
  ...
  "home.topModelsDescription": "Użycie modeli w Nebula.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Nebula według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Nebula Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Nebula, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Nebula.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Nebula",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Nebula",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Nebula z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Nebula Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Nebula, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Nebula pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Nebula z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Nebula z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Nebula w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Nebula, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Nebula.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Nebula w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Nebula w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Nebula.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Nebula nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Nebula.",
