export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Nebula Data",
  "app.description":
    "Nebula kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Nebula Data logosu",
  ...
  "header.githubAria": "GitHub'da Nebula'a yıldız ver",
  "header.github": "GitHub",
  "header.tryNebula": "Nebula'u dene",
  ...
  "footer.homeAria": "Nebula ana sayfası",
  ...
  "home.topModelsDescription": "Nebula genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Nebula kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Nebula Data",
  "lab.description":
    "Nebula'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Nebula kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Nebula'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Nebula kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Nebula token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Nebula Data",
  "model.description":
    "{{model}} için Nebula kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Nebula kullanımı görünür.",
  "model.unranked": "Geçen haftaki Nebula kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Nebula kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Nebula kullanımı yok.",
  ...
  "model.overviewDescription": "Son Nebula tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Nebula kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Nebula token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Nebula kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Nebula oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen Nebula coğrafi satırı yok.",
  "model.peersDescription": "Son Nebula token hacmine göre yakındaki modeller.",
