export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Nebula Data",
  "app.description":
    "Esplora l'utilizzo di Nebula nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Nebula Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Nebula su GitHub",
  "header.github": "GitHub",
  "header.tryNebula": "Prova Nebula",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Nebula.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Nebula per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Nebula Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Nebula, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Nebula.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Nebula",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Nebula",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Nebula negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Nebula Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Nebula, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Nebula appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Nebula della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Nebula della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Nebula nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Nebula, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Nebula.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Nebula nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Nebula nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Nebula.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Nebula corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Nebula.",
