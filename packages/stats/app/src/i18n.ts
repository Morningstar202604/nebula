...
const en = {
  "app.title": "AI Model Usage Rankings | Nebula Data",
  "app.description":
    "Explore Nebula usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Nebula Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Nebula on GitHub",
  "header.github": "GitHub",
  "header.tryNebula": "Try Nebula",
  ...
  "home.topModelsDescription": "Usage of models across Nebula.",
  ...
  "home.uniqueUsersDescription": "Daily unique Nebula users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Nebula Data",
  "lab.description":
    "Compare {{lab}} models used in Nebula, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Nebula usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Nebula",
  ...
  "lab.shareOfUsage": "{{share}} of recent Nebula usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Nebula Data",
  "model.description":
    "View {{model}} Nebula usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Nebula usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Nebula usage",
  "model.ranked": "Ranked #{{rank}} across last week's Nebula usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Nebula usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Nebula usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Nebula geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Nebula token volume.",
