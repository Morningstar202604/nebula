import nebulaWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const themeStorageKey = "nebula:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://nebula.ai/">
            <strong>{i18n.t("header.tryNebula")}</strong>
          </a>
          <button
...
function NebulaMark() {
  return (
    <svg data-slot="nebula-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://nebula.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://nebula.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@nebula.ai", label: i18n.t("footer.contact") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://nebula.ai" aria-label={i18n.t("footer.homeAria")}>
          <NebulaMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={nebulaWordmarkDark} alt="Nebula" />
          <button
