import { Nebula } from "@nebula-ai/client/effect"
...
import { createEmbeddedRoutes } from "@nebula-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Nebula.create")(function* () {
  ...
  const client = yield* Nebula.make({ baseUrl: "http://nebula.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@nebula-ai/sdk-next/Nebula") {}
