...
```
REGISTRY=ghcr.io/Morningstar202604 TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/Morningstar202604 TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/Morningstar202604/build/bun-node:24.04
```
