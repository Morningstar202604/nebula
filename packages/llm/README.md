...
Schema-first LLM core for nebula. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@nebula-ai/llm"
import { OpenAI } from "@nebula-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@nebula-ai/llm/providers"
