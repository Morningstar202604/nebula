...
import { registerNebulaSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@nebula-ai/sdk/v2"
...
import { NEBULA_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useNebulaKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.NEBULA_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
