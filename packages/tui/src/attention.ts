...
import defaultSoundPath from "@nebula-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@nebula-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@nebula-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@nebula-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@nebula-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@nebula-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "nebula"
const DEFAULT_PACK_ID = "nebula.default"
