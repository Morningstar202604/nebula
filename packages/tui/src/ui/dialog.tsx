...
import { useBindings, useNebulaModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useNebulaModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.NEBULA_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
