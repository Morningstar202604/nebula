...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "NEBULA.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/nebula/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/nebula (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/nebula/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/nebula/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const NEBULA_DB|NEBULA_DB|NEBULA_DEV|Global\\.Path\\.data|data =" in packages/nebula/src (115 matches)',
  },
] as const
