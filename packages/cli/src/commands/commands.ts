...
declare const NEBULA_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof NEBULA_CLI_NAME === "string" ? NEBULA_CLI_NAME : "nebula", {
  description: "Nebula 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
