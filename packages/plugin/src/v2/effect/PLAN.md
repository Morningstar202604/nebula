...
- Effect plugins import `@nebula-ai/plugin/v2/effect`, not `@nebula-ai/core`.
- Public domain values use generated `@nebula-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@nebula-ai/plugin/v2/effect`.
