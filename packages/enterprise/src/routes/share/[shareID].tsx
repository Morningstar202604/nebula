import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@nebula-ai/sdk/v2"
import { SessionTurn } from "@nebula-ai/session-ui/session-turn"
import { SessionReview } from "@nebula-ai/session-ui/session-review"
import { DataProvider } from "@nebula-ai/session-ui/context"
import { FileComponentProvider } from "@nebula-ai/ui/context/file"
import { WorkerPoolProvider } from "@nebula-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@nebula-ai/ui/logo"
import { IconButton } from "@nebula-ai/ui/icon-button"
import { ProviderIcon } from "@nebula-ai/ui/provider-icon"
import { iife } from "@nebula-ai/core/util/iife"
import { Binary } from "@nebula-ai/core/util/binary"
import { NamedError } from "@nebula-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@nebula-ai/ui/tabs"
import { MessageNav } from "@nebula-ai/session-ui/message-nav"
import { FileSSR } from "@nebula-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@nebula-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/nebula-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Nebula</Title>
              </Show>
              <Meta name="description" content="nebula - The AI coding agent built for the terminal." />
