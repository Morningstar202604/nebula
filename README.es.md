...
npm i -g nebula-ai@latest        # o bun/pnpm/yarn
scoop install nebula             # Windows
choco install nebula             # Windows
brew install Morningstar202604/tap/nebula # macOS y Linux (recomendado, siempre al día)
brew install nebula              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S nebula            # Arch Linux (Stable)
paru -S nebula-bin               # Arch Linux (Latest from AUR)
mise use -g nebula               # cualquier sistema
nix run nixpkgs#nebula           # o github:Morningstar202604/nebula para la rama dev más reciente
```
...
Nebula también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/Morningstar202604/nebula/releases) o desde [nebula.ai/download](https://nebula.ai/download).
...
1. `$NEBULA_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.nebula/bin` - Alternativa por defecto
...
Nebula incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://nebula.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar Nebula, [**ve a nuestra documentación**](https://nebula.ai/docs).

### Contribuir

Si te interesa contribuir a Nebula, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Nebula

Si estás trabajando en un proyecto basado en Nebula y usas "nebula" como parte del nombre, por ejemplo, "nebula-dashboard" u "nebula-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Nebula y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/nebula) | [X.com](https://x.com/nebula)
