...
Desktop application and browser-based app issues, including `nebula web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core nebula server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Nebula Zen, Nebula Go, and billing issues.
