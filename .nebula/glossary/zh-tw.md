...
- PR #13942: https://github.com/Morningstar202604/nebula/pull/13942

## Do Not Translate (Locale Additions)

- `Nebula` (preserve casing in prose; keep `nebula` only when it is part of commands, package names, paths, or code)
- `Nebula Zen`
- `Nebula CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `nebula` in prose when referring to the product name; use `Nebula`
