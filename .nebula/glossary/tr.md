...
- PR #15835: https://github.com/Morningstar202604/nebula/pull/15835

## Do Not Translate (Locale Additions)

- `Nebula` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `nebula` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Nebula` in prose, `nebula` only for exact technical identifiers
...
- Avoid changing `nebula` to `Nebula` inside commands, URLs, package names, or code literals
