...
brew install Morningstar202604/tap/nebula # macOS і Linux (рекомендовано, завжди актуально)
...
nix run nixpkgs#nebula           # або github:Morningstar202604/nebula для найновішої dev-гілки
```
...
Nebula також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/Morningstar202604/nebula/releases) або [nebula.ai/download](https://nebula.ai/download).
